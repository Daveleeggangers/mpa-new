/* 											 	   
*  											 	   
* IPCamLive.com Player JavaScript Library v7.2.2 
* http://ipcamlive.com/ 					           
* 											     	   
* Copyright (c) 2021 IPCamLive Inc.    	  	 	   
* 	 											   	   
/* 										       	   
...
* 	jquery 1.9.0+
* 
*/var IPC_PLAYER_VERSION="7.2.2",IPC_PLAYER_CCS_VERSION="6",IPC_MAIN_CCS_VERSION="3",IPC_HLS_JS_VERSION="2",IPC_IMAGES_VERSION="3",VIDEO_LOGOPOS_TL="lefttop",VIDEO_LOGOPOS_TR="righttop",VIDEO_LOGOPOS_BL="leftbottom",VIDEO_LOGOPOS_BR="rightbottom",VIDEO_MAX_LOGO_SIZE=6,WAIT_TYPE_BUFFERING=1,WAIT_TYPE_CONNECTING=2,SCM_SHOW=1,SCM_SHOW_IF_NO_STREAM=2,ElementPositions={CENTER:0,BOTTOM:1},DO_NOT_USE_MSE_HLS_PLAYER=!1,DO_NOT_USE_MSE_WS_PLAYER=!1,DO_NOT_USE_NATIVE_HLS_PLAYER=!1,NATIVE_TEST_WITH_MP4=!1,EMULATE_MOBILE_MODE=
!1;1==DO_NOT_USE_NATIVE_HLS_PLAYER&&console.log("Native player not enabled! DO NOT RELEASE THIS!");1==EMULATE_MOBILE_MODE&&console.log("Emulate mobile device enabled! DO NOT RELEASE THIS!");
var defaultServerHost="http://player.ipcamlive.com/",ipcamliveHostManager=new function(){var b,d;this.checkHTTPS=function(){null!=d&&(null!=location&&"https:"===location.protocol&&(d=d.replace("http://","https://")),b=d+"player/html5player/images-"+IPC_IMAGES_VERSION+"/")};this.setHostURL=function(a){d=a;this.checkHTTPS()};this.getHostURL=function(){return d};this.getHostURL=function(a){return d+a};this.getImagePathURL=function(){return b};this.setHostURL(defaultServerHost)},ipcamlivehelper=new function(){this.addErrorTextTable=
function(b,d,a,e,c){void 0==e&&(e=ipcStyleManager.getStyleByName("default",!0,!1));var h="";1==a&&""!=e.errorPage.icon&&(h='<img src="'+e.errorPage.icon+'" style="width: 48px; height: 48px; vertical-align:middle; padding-bottom:4px">');a="";1==c&&(a="display: none;");var k=ipcStyleManager.buildCSSFilterString(e.filters);$("#"+b).html('<div style="width: 100%; height: 100%; background-color: '+e.errorPage.backgroundColor+';"><table id="'+b+'_errorTableText" style="width: 100%; height: 100%; '+a+k+
'"><td style="text-align:center">'+h+'<span style="color: '+e.errorPage.textColor+"; font-family:"+e.text.fontFamily+'; font-weight: bold; padding-right: 12px; text-shadow: 1px 1px #000;">'+d+"</span></td></table></div>");1==c&&$("#"+b+"_errorTableText").fadeIn(500)};this.addErrorText=function(b,d,a,e){var c=$("#"+b+"_connectingimg");0<c.length?c.fadeOut(500,function(){ipcamlivehelper.addErrorTextTable(b,d,a,e,!0)}):this.addErrorTextTable(b,d,a,e,!1)};this.showStreamStartTimer=function(b,d,a){if(0<
a){var e=Math.floor(a/3600);a-=3600*e;var c=Math.floor(a/60);a-=60*c;var h=" ";0<e&&(h=h+e+"h ");if(0<e||0<c)h=h+c+"m ";if(0<e||0<c||0<a)h=h+a+"s ";this.addErrorText(b,ipcLocale.cameraStartInSec+h,1,d)}else this.addErrorText(b,ipcLocale.cameraStartSoon,1,d)};this.getPosByID=function(b){switch(b){case "TL":return VIDEO_LOGOPOS_TL;case "TR":return VIDEO_LOGOPOS_TR;case "BL":return VIDEO_LOGOPOS_BL;case "BR":return VIDEO_LOGOPOS_BR;default:return VIDEO_LOGOPOS_BL}};this.createTimeout=function(b,d){var a=
setTimeout(b,d);return{cancel:function(){clearTimeout(a)},trigger:function(){clearTimeout(a);return b()}}};this.resizeElement=function(b,d,a,e,c,h){var k=Math.min(e.isMinWidthPercent||e.isMaxWidthPercent?.9*b.clientWidth:.25*b.clientWidth,e.isMaxWidthPercent?e.maxWidth*b.clientWidth:e.maxWidth);k=Math.max(k,e.isMinWidthPercent?e.minWidth*b.clientWidth:e.minWidth);a=a.height/a.width*k;void 0==h&&(h=ElementPositions.CENTER);switch(h){case ElementPositions.CENTER:var p=b.clientWidth/2-k/2;var l=b.clientHeight/
2-a/2;break;case ElementPositions.BOTTOM:p=b.clientWidth/2-k/2,l=b.clientHeight-a-25}d.css({left:p+"px",top:l+"px",width:k+"px",height:a+"px"});void 0!=c&&1==c&&void 0!=e.stateCount&&d.css("background-size",k*e.stateCount+"px "+a+"px")};this.printf=function(b){return Array.prototype.slice.call(arguments,1).reduce(function(b,a){return b.replace(/%s/,a)},b)};this.isURL=function(b){return!!/^(https?:\/\/)?((([a-z\d]([a-z\d-]*[a-z\d])*)\.)+[a-z]{2,}|((\d{1,3}\.){3}\d{1,3}))(\:\d+)?(\/[-a-z\d%_.~+]*)*(\?[;&a-z\d%_.~+=-]*)?(\#[-a-z\d_]*)?$/i.test(b)};
this.getBoundingCSSRect=function(b){var d={};d.left=parseInt(b.css("left"));d.top=parseInt(b.css("top"));d.right=d.left+b.width();d.bottom=d.top+b.height();return d};this.generateString=function(b){for(var d="",a=0;a<b;a++)d+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(Math.floor(62*Math.random()));return d}},AABB={intersectArea:function(b,d){var a=Math.min(b.right,d.right)-Math.max(b.left,d.left);b=Math.min(b.bottom,d.bottom)-Math.max(b.top,d.top);d=0;0<a&&0<b&&(d=a*b);
return d},collide:function(b,d,a,e){!0===a?(b=ipcamlivehelper.getBoundingCSSRect(b),d=ipcamlivehelper.getBoundingCSSRect(d)):(b=b.getBoundingClientRect(),d=d.getBoundingClientRect());if(0!=!(b.top>d.bottom||b.right<d.left||b.bottom<d.top||b.left>d.right)&&void 0!=e){a=(b.right-b.left)*(b.bottom-b.top);var c=(d.right-d.left)*(d.bottom-d.top);return AABB.intersectArea(b,d)/(a<c?a:c)>e}return!1},inside:function(b,d){b=b.getBoundingClientRect();d=d.getBoundingClientRect();return d.top<=b.top&&b.top<=
d.bottom&&d.top<=b.bottom&&b.bottom<=d.bottom&&d.left<=b.left&&b.left<=d.right&&d.left<=b.right&&b.right<=d.right}},dependencyhelper=new function(){var b=window,d=document,a=navigator,e=[];this.toInt=function(c){return parseInt(c,10)};this.detectFlashParams=function(){var c="undefined"!==typeof d.getElementById&&"undefined"!==typeof d.getElementsByTagName&&"undefined"!==typeof d.createElement,e=a.userAgent.toLowerCase(),k=a.platform.toLowerCase(),p=k?/win/.test(k):/win/.test(e);k=k?/mac/.test(k):
/mac/.test(e);e=/webkit/.test(e)?parseFloat(e.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,"$1")):!1;var l="Microsoft Internet Explorer"===a.appName,q=[0,0,0],g=null;if("undefined"!==typeof a.plugins&&"object"===typeof a.plugins["Shockwave Flash"])(g=a.plugins["Shockwave Flash"].description)&&"undefined"!==typeof a.mimeTypes&&a.mimeTypes["application/x-shockwave-flash"]&&a.mimeTypes["application/x-shockwave-flash"].enabledPlugin&&(plugin=!0,l=!1,g=g.replace(/^.*\s+(\S+\s+\S+$)/,"$1"),q[0]=this.toInt(g.replace(/^(.*)\..*$/,
"$1")),q[1]=this.toInt(g.replace(/^.*\.(.*)\s.*$/,"$1")),q[2]=/[a-zA-Z]/.test(g)?this.toInt(g.replace(/^.*[a-zA-Z]+(.*)$/,"$1")):0);else if("undefined"!==typeof b.ActiveXObject)try{if(g=(new ActiveXObject("ShockwaveFlash.ShockwaveFlash")).GetVariable("$version"))l=!0,g=g.split(" ")[1].split(","),q=[this.toInt(g[0]),this.toInt(g[1]),this.toInt(g[2])]}catch(F){}return{w3:c,pv:q,wk:e,ie:l,win:p,mac:k}};this.hasFlashPlayerVersionLocal=function(c){c+="";var a=this.detectFlashParams().pv;c=c.split(".");
c[0]=this.toInt(c[0]);c[1]=this.toInt(c[1])||0;c[2]=this.toInt(c[2])||0;return a[0]>c[0]||a[0]==c[0]&&a[1]>c[1]||a[0]==c[0]&&a[1]==c[1]&&a[2]>=c[2]?!0:!1};this.isAllCSSLoaded=function(){return 0===e.length?!1:1===e[0].state};this.load_item=function(c,a,b){for(var d=0;d<e.length;d++)if(e[d].js===c){0===e[d].state?e[d].cbs.push(a):a();return}e.push({js:c,state:0,cbs:[a]});c=document.getElementsByTagName("head")[0];b.onload=function(){var c=b.href?b.href:b.src;for(var a=0;a<e.length;a++)if(e[a].js===
c){e[a].state=1;c=e[a].cbs;for(a=0;a<c.length;a++)c[a]();break}};b.onreadystatechange=function(){if("complete"==this.readyState)b.onload()};c.appendChild(b)};this.createVersionedFileName=function(c,a,b){return c+"-"+a+b};this.createVersionedJSFileName=function(c,a){return this.createVersionedFileName(c,a,".js")};this.createVersionedCSSFileName=function(c,a){return this.createVersionedFileName(c,a,".css")};this.load_js=function(c,a){var b=document.createElement("script");b.src=c;b.type="text/javascript";
this.load_item(b.src,a,b)};this.load_css=function(c,a){var b=document.createElement("link");b.rel="stylesheet";b.type="text/css";b.href=c;this.load_item(b.href,a,b)};this.remove_item_cb=function(c,a){for(var b=0;b<e.length;b++)if(e[b].js===c){c=e[b].cbs.indexOf(a);-1!==c&&e[b].cbs.splice(c,1);break}};this.preload_image=function(c){(new Image).src=c}},browserhelper=new function(){var b=!1,d=void 0,a={},e=void 0;this.getParam=function(c,a,b){return void 0!=c&&c.hasOwnProperty(a)?c[a]:b};this.enableDebugLog=
function(c){b=this.getParam(c,"enabledebuglog",!1);1==b&&this.log("Debug log enabled")};this.log=function(c){console&&1==b&&(console.log(c),browserhelper.ui_log(c))};this.forceLog=function(c){console&&(console.log(c),browserhelper.ui_log(c))};this.isEdge=function(){if(void 0!=a.isEdge)return a.isEdge;a.isEdge=/Edge/i.test(navigator.userAgent);return a.isEdge};this.isHigherPlatform=function(c){return platform.version>=c||parseInt(platform.version)>=c};this.isMobileBrowser=function(){if(1==EMULATE_MOBILE_MODE)return!0;
if(void 0!=a.isMobileBrowser)return a.isMobileBrowser;if(is.mobile()||is.touchDevice()&&is.safari())return a.isMobileBrowser=!0,a.isMobileBrowser;if(is.windowsTablet()){if(void 0!=d)return d;this.log("Windows touch device detected (NoteBook/Tablet)");var c=document.createElement("video");if(c.canPlayType)return d=""!=c.canPlayType("application/x-mpegurl")||""!=c.canPlayType("application/vnd.apple.mpegurl"),this.log("\tCheck with video.canPlayType: "+d),d;d=!1;this.log("\tVideo.canPlayType not available...");
return 10<=platform.os.version}return is.tablet()};this.isBrowserSupportNativeHLS=function(){if(void 0!=d)return d;var c=document.createElement("video");return d=c.canPlayType?""!=c.canPlayType("application/x-mpegurl")||""!=c.canPlayType("application/vnd.apple.mpegurl"):!1};this.isNativeHLSSupported=function(){if(1==DO_NOT_USE_NATIVE_HLS_PLAYER)return!1;if(1==NATIVE_TEST_WITH_MP4)return!0;if(void 0!=a.isNativeHLSSupported)return a.isNativeHLSSupported;if(is.safari()&&is.windows())return a.isNativeHLSSupported=
!1,a.isNativeHLSSupported;if(/Edge/i.test(navigator.userAgent)||0==EMULATE_MOBILE_MODE&&(this.isMobileBrowser()||is.safari()))return this.log("Enable native HLS"),a.isNativeHLSSupported=!0,a.isNativeHLSSupported;var c=this.isHTML5HLSSupported(),b=this.isBrowserSupportNativeHLS(),d=dependencyhelper.hasFlashPlayerVersionLocal("10.1.0");(b=0==c&&1==b&&0==d)?this.log("Enable native HLS"):c?this.log("Native HLS not supported, using MSE"):d?this.log("Native HLS not supported, using FLASH"):this.log("Nothing supported (HLS, FLASH, Native HLS)");
a.isNativeHLSSupported=b;return a.isNativeHLSSupported};this.isStableBrowserForHTML5_HLS=function(){if(DO_NOT_USE_MSE_HLS_PLAYER)return!1;if(void 0!=a.isStableBrowserForHTML5_HLS)return a.isStableBrowserForHTML5_HLS;var c=platform.name+" / "+platform.version+" / "+platform.os.version;if(is.chrome())return this.log(c+" (detect: Chrome)"),a.isStableBrowserForHTML5_HLS=!0,a.isStableBrowserForHTML5_HLS;if(is.opera())return 1==browserhelper.isHigherPlatform(27)?(this.log(c+" (detect: Opera > 27)"),a.isStableBrowserForHTML5_HLS=
!0):(this.log(c+" (detect: Opera <= 27)"),a.isStableBrowserForHTML5_HLS=!1),a.isStableBrowserForHTML5_HLS;if(is.firefox())return 1==browserhelper.isHigherPlatform(45)?(this.log(c+" (detect: Firefox > 45)"),a.isStableBrowserForHTML5_HLS=!0):(this.log(c+" (detect: Firefox <= 45)"),a.isStableBrowserForHTML5_HLS=!1),a.isStableBrowserForHTML5_HLS;if(/Edge/i.test(navigator.userAgent))return this.log(c+" (detect: Edge)"),a.isStableBrowserForHTML5_HLS=!0,a.isStableBrowserForHTML5_HLS;if(is.ie())return this.log(c+
" (detect: IE)"),a.isStableBrowserForHTML5_HLS=!1,a.isStableBrowserForHTML5_HLS;this.log(c+" (detect: unknown)");a.isStableBrowserForHTML5_HLS=dependencyhelper.hasFlashPlayerVersionLocal("10.1.0");return dependencyhelper.hasFlashPlayerVersionLocal("10.1.0")};this.isHLSSupported=function(){if(void 0!=a.isHLSSupported)return a.isHLSSupported;a.isHLSSupported=window.MediaSource&&window.MediaSource.isTypeSupported('video/mp4; codecs="avc1.42E01E,mp4a.40.2"');return a.isHLSSupported};this.isHTML5HLSSupported=
function(){if(void 0!=a.isHTML5HLSSupported)return a.isHTML5HLSSupported;a.isHTML5HLSSupported=this.isStableBrowserForHTML5_HLS()&&this.isHLSSupported();return a.isHTML5HLSSupported};this.isHTML5Supported=function(){if(void 0!=a.isHTML5Supported)return a.isHTML5Supported;if(this.isNativeHLSSupported())a.isHTML5Supported=!0;else{var c=this.isHTML5HLSSupported();a.isHTML5Supported=c}return a.isHTML5Supported};this.isWebSocketSupported=function(){if(DO_NOT_USE_MSE_WS_PLAYER)return!1;if(void 0!=a.isWebSocketSupported)return a.isWebSocketSupported;
a.isWebSocketSupported=window.WebSocket&&window.MediaSource&&window.MediaSource.isTypeSupported('video/mp4; codecs="avc1.42E01E,mp4a.40.2"');return a.isWebSocketSupported};this.isInlineSupportedOnIPhone=function(){if(void 0!=a.isInlineSupportedOnIPhone)return a.isInlineSupportedOnIPhone;is.iphone()||is.ipod()?a.isInlineSupportedOnIPhone="playsInline"in document.createElement("video")&&1==browserhelper.isHigherPlatform(10):a.isInlineSupportedOnIPhone=!1;return a.isInlineSupportedOnIPhone};this.isSafariMobile=
function(){if(void 0!=a.isSafariMobile)return a.isSafariMobile;if(0==is.safari())return a.isSafariMobile=!1,a.isSafariMobile;if(is.iphone()||is.ipod())return a.isSafariMobile=0==this.isInlineSupportedOnIPhone(),a.isSafariMobile;var c=document.createElement("div");c="webkitRequestFullScreen"in c||"requestFullScreen"in c?!1:0=="webkitEnterFullScreen"in document.createElement("video");a.isSafariMobile=c;return a.isSafariMobile};this.hexToRgb=function(c){c=c.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,
function(c,a,b,d){return a+a+b+b+d+d});return(c=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(c))?{r:parseInt(c[1],16),g:parseInt(c[2],16),b:parseInt(c[3],16)}:null};this.deepTest=function(c,a){a=a.split(".");for(c=c[a.shift()];c&&a.length;)c=c[a.shift()];return c};this.checkNested=function(c){for(var a=Array.prototype.slice.call(arguments,1),b=0;b<a.length;b++){if(!c||!c.hasOwnProperty(a[b]))return!1;c=c[a[b]]}return!0};this.getTextWidth=function(c,a){var b=document.createElement("canvas").getContext("2d");
b.font=a;return b.measureText(c).width};this.createLoggerWindow=function(c){$("#"+c).append("<div id="+c+'_console_div style="position: absolute; background-color: #fff; width: 400px; height: 400px"> <textarea \tid='+c+'_console_memo   style="resize:none; width:400px; height:400px"></textarea></div>');e=document.getElementById(c+"_console_memo")};this.ui_log=function(c){void 0!=e&&(e.value+=c,e.value+="\n")};this.isIOS13OrLater=function(){if(void 0!=a.isIOS13OrLater)return a.isIOS13OrLater;"MacIntel"==
navigator.platform?a.isIOS13OrLater=!0:is.ipad()||is.iphone()||is.ipod()?a.isIOS13OrLater=1==browserhelper.isHigherPlatform(13):a.isIOS13OrLater=!1;browserhelper.log("Is iOS 13 or later: "+a.isIOS13OrLater);return a.isIOS13OrLater};this.getOverflowValue=function(c){return 1==browserhelper.isIOS13OrLater()&&1==this.getParam(c,"iframemode",!1)?"":"overflow:hidden;"};this.inIframe=function(){try{return window.self!==window.top}catch(c){return!0}}},multilevelhelper=new function(){this.calcWeightX=function(b,
...
d.initEvent("click",!0,!0),b.dispatchEvent(d)):b.click&&b.click()};this.downloadCanvasAsImage=function(b,d){this.downloadCanvasAsImage_IE(b,d)||this.downloadCanvasAsImage_Other(b,d)};this.captureFrame=function(b,d){var a=document.createElement("canvas");a.width=b.videoWidth;a.height=b.videoHeight;a.getContext("2d").drawImage(b,0,0,a.width,a.height);b=(d?d:"Snapshot")+"-"+this.createDateString()+".jpg";this.downloadCanvasAsImage(a,b)}};
function basicWatchDog(b,d,a,e){function c(){k=0;null!=h&&(browserhelper.log(b+" WatchDog stopped."),window.clearInterval(h),h=null)}var h=null,k=0;this.start=function(){null==h&&(browserhelper.log(b+" WatchDog started."),h=window.setInterval(function(){var d=Date.now();0<k&&k+a<d&&(c(),browserhelper.log(b+" Watchdog fail, no signal received in the last "+a+"ms."),e())},d))};this.stop=function(){c()};this.signal=function(){k=Date.now()}}
function liveVideoPlayer(){var b,d={},a=void 0,e=void 0;this.player=function(c,h){if(browserhelper.isHTML5Supported())b=new ihtml5video(d);else if(dependencyhelper.hasFlashPlayerVersionLocal("10.1.0"))b=new iflashvideo;else return"On this platform you need Adobe Flash player to play this video stream.";b.setCheckStreamState(e);b.setExtraParams(a);b.player(c,h,!1);return!0};this.setEvents=function(c,a){void 0!=b&&b.setEvents(c,a)};this.destroyObjects=function(){void 0!=b&&b.destroyObjects()};this.resize=
function(){void 0!=b&&b.resize()};this.setExtraParams=function(c){a=c};this.setCheckStreamState=function(a){e=a};this.setSnippets=function(a){void 0!=b&&b.setSnippets(a)}}
function iplayerEx(){var b=void 0,d=void 0,a,e,c,h=void 0,k,p,l,q,g,F,v="",n=-1,H=!1,J=!0,r=0,A,t,y,D,u=0,E=void 0,B=function(a){ipcLM.setLocaleFromParam(c.locale);c.customskinurl?$.getJSON(c.customskinurl).done(function(b){c.style=ipcStyleManager.inheritStyle(b,!0,!0);a()}).fail(function(b,f,d){c.style=ipcStyleManager.getStyleByName(c.skin,!0,!0);a()}):(c.style=ipcStyleManager.getStyleByName(c.skin,!0,!0),a())},Q=function(a,c){$.get(ipcamliveHostManager.getHostURL("player/validatepin.php"),{_:$.now(),
alias:e,pin:a},function(a){var b=!1;"ok"==a.result&&void 0!=a.data.token&&(v=a.data.token,b=!0);c(b)},"json").fail(function(a,b,f){c(!1)})},R=function(b){var f=dependencyhelper.createVersionedCSSFileName("player/html5player/pin",1);dependencyhelper.load_css(ipcamliveHostManager.getHostURL(f),function(){var f=new htmlEditHelperClass;f.setContainerName(a);var d=$("#"+a);d.empty();d=f.appendDiv(d,"pinPanelBack","pinLogin-back");var z=f.appendDiv(d,"pinPanelCont","pinLogin-container");f.appendDiv(z,"pinPanelText",
"pinLogin-text").text(ipcLocale.enterPin);var e=new Pinlogin(z[0],c.style.colors.main,{fields:4,complete:function(a){Q(a,function(a){1==a?z.fadeOut(500).queue(function(){b()}):(e.reset(),u++,3==u?(e.disable(),u=30,E=setInterval(function(){u--;0<u?g.text(ipcamlivehelper.printf(ipcLocale.waitBeforeNextPin,u)):(g.animate({opacity:"0.0"},500),clearInterval(E),e.enable())},1E3),g.text(ipcamlivehelper.printf(ipcLocale.waitBeforeNextPin,u)),g.animate({opacity:"1.0"},500)):(g.text(ipcLocale.invalidPin),g.animate({opacity:"1.0"},
500).delay(2500).animate({opacity:"0.0"},500)))})}}),g=f.appendDiv(z,"pinPanelTextInvalid","pinLogin-text-invalid");g.text(ipcLocale.invalidPin)})},M=function(b){var f=$("#"+a+"_connectingimg");if(f&&(f.is(":visible")||1==b)){var d=$("#"+a);ipcamlivehelper.resizeElement(d[0],f,c.style.loading.buffering,c.style.loading.limits);1==b&&f.show()}},K=function(a){void 0!=c.rtcsupport&&0!=c.rtcsupport&&ipcamliveHostManager.getHostURL()===defaultServerHost&&$.getJSON(defaultServerHost+"player/getgroupaddress.php?alias="+
a).done(function(a){void 0!=a.address&&(browserhelper.log("New endpoint received: "+a.address),ipcamliveHostManager.setHostURL(a.address))}).fail(function(a,c,b){browserhelper.log("Endpoint received failed! Status: "+c+"; Code: "+b)})};this.setOnCreateVideoPlayer=function(a){d=a};this.setToken=function(a){v=a};this.embed=function(b,d,g){browserhelper.forceLog("Player Version: "+IPC_PLAYER_VERSION);a=b;e=d;c=g;void 0===c&&(c={});c.alias=e;browserhelper.enableDebugLog(c);B(function(){K(e);w(45E3,SCM_SHOW_IF_NO_STREAM);
C()})};this.embedOnline=function(b,d,g,U,m,h,q){browserhelper.forceLog("Player Version: "+IPC_PLAYER_VERSION);a=b;e=d;p=g;k=U;l=m;c=q;c.alias=e;void 0!=h&&null!=h&&0<h&&(c.websocketport=h);N(q.timeshiftenabled);browserhelper.enableDebugLog(c);B(function(){K(e);L();C()})};this.resize=function(){b?b.resize():M(!1)};this.setExtraParams=function(a){h=a};this.getWebSocketDelay=function(){return void 0!=b?b.getWebSocketDelay():0};this.setSnippets=function(a){void 0!=b&&b.setSnippets(a)};var N=function(a){void 0!=
a&&1==a?(q=l+"streams_timeshift/",g=l+"streams_timeshift/"):(q=l+"streams/",g=l+"streams/");q=q+p+"/stream.m3u8";g=g+p+"/snapshot.jpg"},C=function(){var a=browserhelper.isHTML5Supported()?"HTML5":"Flash";$.get(ipcamliveHostManager.getHostURL("player/registerviewer.php"),{_:$.now(),alias:e,type:a},function(a){"ok"==a.result&&(n=a.data.viewerid)},"json").fail(function(a,c,b){registerViewerTimer=setTimeout(function(){C()},1E3)})},x=function(b){switch(b){case WAIT_TYPE_BUFFERING:b=c.style.loading.buffering.anim;
break;case WAIT_TYPE_CONNECTING:b=c.style.loading.connecting.anim;break;default:return}var d=ipcStyleManager.buildCSSFilterString(c.style.filters);$("#"+a).html('<div style="width: 100%; height: 100%; background-color: '+c.style.colors.loadingBackground+'; color: #ffffff; text-align:initial;"><img id="'+a+'_connectingimg" src="'+b+'" style="position: relative; display: none; '+d+'"/></div>');$("#"+a+"_connectingimg").on("load",function(){M(!0)})},m=function(){var a="";try{a=window.location.hostname}catch(z){}return a},
w=function(b,d){var f=m();void 0!=d&&(F=0,d==SCM_SHOW&&x(WAIT_TYPE_CONNECTING));clearTimeout(t);t=setTimeout(function(){$.get(ipcamliveHostManager.getHostURL("player/getcamerastreamstate.php"),{_:$.now(),token:v,alias:e,targetdomain:f,getstreaminfo:1},function(f){J=!1;if(1==f.details.streamavailable){p=f.details.streamid;l=f.details.address;k=f.details.servicetype;N(f.details.timeshiftenabled);c.audioenabled=f.details.audioenabled;c.timelapseenabledoncamera=f.details.timelapseenabled;1==f.details.logoenabled&&
(c.logo=ipcamliveHostManager.getHostURL("resources/logos/"+f.details.logofilename),c.logopos=ipcamlivehelper.getPosByID(f.details.logopos));1==f.details.forceautostop&&(c.autostopaftersec="300");1==f.details.blockautoplay&&(c.autoplay=0);void 0!=f.details.websocketport&&null!=f.details.websocketport&&0<f.details.websocketport&&(c.websocketport=f.details.websocketport);var e=browserhelper.isHTML5Supported()?1:3;"undefined"!=typeof f.streaminfo&&"undefined"!=typeof f.streaminfo.live&&f.streaminfo.live.segmentcount>=
e?(c.levels=f.streaminfo.live.levels,L()):(x(WAIT_TYPE_BUFFERING),G(b+45E3))}else void 0!=f.details.enabled&&0==f.details.enabled?ipcamlivehelper.addErrorText(a,ipcLocale.cameraNotAvailable,1,c.style):"undefined"!=typeof f.details.cameracannotbeembedded&&f.details.cameracannotbeembedded?"undefined"!=typeof f.details.tokenexpired&&f.details.tokenexpired?ipcamlivehelper.addErrorText(a,ipcLocale.tokenExpired,0,c.style):"undefined"!=typeof f.details.cameracannotbeembedded_nsp&&f.details.cameracannotbeembedded_nsp?
ipcamlivehelper.addErrorText(a,ipcLocale.cannotEmbeddPackege,0,c.style):"undefined"!=typeof f.details.cameracannotbeembedded_itd&&f.details.cameracannotbeembedded_itd?ipcamlivehelper.addErrorText(a,ipcLocale.cannotEmbeddDomain,0,c.style):"undefined"!=typeof f.details.cameracannotbeembedded_pin&&f.details.cameracannotbeembedded_pin?R(function(){w(45E3,SCM_SHOW_IF_NO_STREAM)}):ipcamlivehelper.addErrorText(a,ipcLocale.cannotEmbedd,0,c.style):1==f.details.operationtimewindowenabled&&1!=f.details.operationtimewindowactive?
(r=f.details.operationtimewindow_starttimesec+15,O(!0)):(F+=1E3,F<b?(void 0!=d&&d==SCM_SHOW_IF_NO_STREAM&&x(WAIT_TYPE_CONNECTING),w(b)):ipcamlivehelper.addErrorText(a,ipcLocale.cameraNotAvailable,1,c.style))},"json").fail(function(a,c,f){a=J;J=!1;w(b,1==a?SCM_SHOW:void 0)})},1E3)},G=function(b){var f=m();clearTimeout(y);y=setTimeout(function(){$.get(ipcamliveHostManager.getHostURL("player/getcamerastreamstate.php"),{_:$.now(),token:v,alias:e,targetdomain:f,getstreaminfo:1},function(f){var d=browserhelper.isHTML5Supported()?
1:3;"undefined"!=typeof f.streaminfo&&"undefined"!=typeof f.streaminfo.live&&f.streaminfo.live.segmentcount>=d?L():(F+=1E3,F<b?G(b):ipcamlivehelper.addErrorText(a,ipcLocale.cameraNotAvailable,1,c.style))},"json").fail(function(a,c,f){G(b)})},1E3)},S=function(a){var c=m();void 0==a&&(a=6E4);void 0!=A&&A.cancel();A=ipcamlivehelper.createTimeout(function(){var a={_:$.now(),token:v,alias:e,targetdomain:c};H&&(a.viewerid=n);$.get(ipcamliveHostManager.getHostURL("player/getcamerastreamstate.php"),a,function(a){1==
a.details.streamavailable&&p==a.details.streamid?S():w(9E4,SCM_SHOW)},"json").fail(function(a,c,b){S(5E3)})},a)},O=function(b){b&&ipcamlivehelper.showStreamStartTimer(a,c.style,r);clearTimeout(D);D=setTimeout(function(){r--;ipcamlivehelper.showStreamStartTimer(a,c.style,r);0<r?15<r&&0==r%10?w(45E3):O(!1):w(45E3)},1E3)},I=function(f){b=void 0==f?new liveVideoPlayer:f;b.setExtraParams(h);b.setCheckStreamState(function(){void 0!=A&&A.trigger()});!0!==(f=b.player(a,c))?ipcamlivehelper.addErrorText(a,
f,0,c.style):(b.setEvents(T,P),S())},L=function(){"https:"===location.protocol&&(l=l.replace("http://","https://"),q=q.replace("http://","https://"),g=g.replace("http://","https://"));void 0!=A&&A.cancel();clearTimeout(t);clearTimeout(y);clearTimeout(D);void 0!=b&&(b.destroyObjects(),b=null);void 0===c&&(c={});c.source=q;c.poster=g;c.address=l;c.streamid=p;c.servicetype=k;"B"==k&&(c.logo=ipcamliveHostManager.getHostURL("player/logo.png"),c.logopos=VIDEO_LOGOPOS_BL,c.autostopaftersec="300");var a=
void 0;void 0!=d&&(a=d(c));void 0!=a?I(a):I(new liveVideoPlayer)},T=function(){H=!0;A.trigger()},P=function(){H=!1}}
function ihtml5video(b){function d(a,c){clearTimeout(G);G=setTimeout(function(){k(c)},a)}function a(a,c){var b=$("#"+n+"_logo");void 0!=b&&void 0!=b[0]&&(1==AABB.collide(b[0],a[0])&&1==c?b.animate({opacity:"0.0"},250):b.animate({opacity:"1.0"},250))}function e(a,b){a=$("#"+n+"_videoplayer");browserhelper.log("Stop native video, reembed player");clearTimeout(G);clearTimeout(K);clearTimeout(S);null!=I&&I();var c=void 0;void 0==x?(void 0!=a&&void 0!=a[0]&&(a[0].src="",a[0].load()),void 0!=m&&m.ipc_detachVideoControls()):
c=x.detachVideoPlayer(b);if(c&&0==c.reembedNeeded)return!1;$("#"+n).empty();E=u=0;D=!1;x=m=void 0;B=y=!1;window.removeEventListener("resize",k);window.removeEventListener("playing",q,!0);return!0}function c(a){if(0!=e(a))return v(n,H,J,a&&1==a),m}function h(a){void 0!=a&&1==a?void 0!=M&&M():($("#"+n+"_videoplayer"),T=!0,browserhelper.log("Cannot connect with WebSocket, fallback to HLS"),c(!0))}function k(a){if(void 0!=w){if(is.safari()){if(void 0!=a&&0==a){$("#"+n+"_logo").css("opacity",0);d(500,
1);return}if(void 0==a&&0==$("#"+n+"_logo").css("opacity"))return}var c=w.width();a=w.height();if(1!=y||0!=c&&0!=a&&0!=u&&0!=E){var b=25/C,f=$("#"+n+"_videoplayer");if(void 0==f||void 0==f[0])d(100);else{var e=f[0].videoWidth,g=f[0].videoHeight;0==e&&0==g?d(100):0==B&&(void 0!=m&&(1280<=e&&720<=g?m.set_HDState(!0):m.set_HDState(!1)),B=!0);if(0!=B){var h=u,k=E,q=!1;void 0!=m&&(m.updateFit(),q=m.get_isVideoFit());var l=c/e<=a/g;var p=e/g;g=c;var r=a;0==q&&(1==l?(r=c/p,g=c):(g=a*p,r=a));if(0<h&&0<k){p=
h*VIDEO_MAX_LOGO_SIZE-g;var x=k*VIDEO_MAX_LOGO_SIZE-r;0<p&&p>x?(p=h/k,h=Math.max(32,g/VIDEO_MAX_LOGO_SIZE),k=h/p):0<x&&x>p&&(p=k/h,k=Math.max(32,r/VIDEO_MAX_LOGO_SIZE),h=k/p)}0==e||0==h||q?(e=t==VIDEO_LOGOPOS_TL?c-h-b:b,q=b,l=t==VIDEO_LOGOPOS_TL||t==VIDEO_LOGOPOS_TR?b:a-k-b,c=t==VIDEO_LOGOPOS_TL||t==VIDEO_LOGOPOS_BL?b:c-h-b):1==l?(l=(a-r)/2,e=t==VIDEO_LOGOPOS_TL?c-h-b:b,q=l+b,l=t==VIDEO_LOGOPOS_TL||t==VIDEO_LOGOPOS_TR?l+b:a-l-k-b,c=t==VIDEO_LOGOPOS_TL||t==VIDEO_LOGOPOS_BL?b:c-h-b):(l=(c-g)/2,e=t==
VIDEO_LOGOPOS_TL?c-l-h-b:l+b,q=b,c=t==VIDEO_LOGOPOS_TL||t==VIDEO_LOGOPOS_BL?l+b:c-l-h-b,l=t==VIDEO_LOGOPOS_TL||t==VIDEO_LOGOPOS_TR?b:a-k-b);c+=w.offset().left;l+=w.offset().top;void 0!=m&&(D=l+k>a-m.get_controlBarHeight()-b,1==D&&(l=m.get_controlBarTop()-k-b));$("#"+n+"_logo").offset({top:l,left:c});$("#"+n+"_logo").width(h).height(k);$("#"+n+"_logo").show();$("#"+n+"_logo").css("opacity",1);1==isAudioEnabled&&f[0].muted&&m.setUnmuteButton({left:e,top:q})}}}else browserhelper.log("Invalid logo params:"+
c+"x"+a+", "+u+"x"+E),d(1E3)}}function p(){Q&&Q()}function l(){if(void 0==A||1==y||void 0==w)k();else{y=!0;w.append('<img id="'+n+'_logo" src="'+A+'" style="position: absolute; z-index: 2147483647;">');var a=$("#"+n+"_logo");a.css("opacity",0);a.css("pointer-events","none");a.on("load",function(){u=$(this).width();E=$(this).height();browserhelper.isMobileBrowser()&&(u/=C,E/=C);k(1)}).attr("src",a.attr("src"))}}function q(a){var b=$("#"+n+"_videoplayer");a.target==b[0]&&(l(),window.removeEventListener("playing",
q,!0),ipcStyleManager.setBackgroundColor(b,H.style.colors.videoBackground))}function g(a,b,c){return void 0!=a&&a.hasOwnProperty(b)?a[b]:c}function F(){void 0!=N&&(clearTimeout(K),K=setTimeout(function(){void 0==m?c():(F(),m.showContinueWatchMessage())},1E3*N))}function v(d,e,l,u){H=e;r=e.source;n=d;J=l;if(e.hasOwnProperty("source")){void 0!=P&&(browserhelper.log("Extra Params: "),browserhelper.log(P));void 0==ipcLocale&&ipcLM.setDefaultLocale();var f=browserhelper.isMobileBrowser();e.hasOwnProperty("levels");
C=window.devicePixelRatio;1==f&&1<C&&(C/=2);var v=browserhelper.isNativeHLSSupported();1==v&&1==g(P,"desktop_safari_force_mse",!1)&&0==f&&is.safari()&&1==browserhelper.isHigherPlatform(8)&&(v=!1,browserhelper.log("Force use MSE player instead of native HLS"));var z="";isAudioEnabled=g(e,"audioenabled",!0);if(e.hasOwnProperty("mute")&&e.mute||0==isAudioEnabled)z="muted ";if(L=0==isAudioEnabled&&1==g(e,"websocketenabled",!1)&&0==T&&browserhelper.isWebSocketSupported()&&0==l&&void 0!=e.websocketport)r=
"https:"===location.protocol?r.replace("https://","wss://"):r.replace("http://","wss://"),r=(new URL(r)).origin+":"+e.websocketport,console.log("WebSocket URL: "+r);A=g(e,"logo");t=g(e,"logopos");N=g(e,"autostopaftersec",3600);var y="";e.hasOwnProperty("autoplay")&&1==u&&e.autoplay&&(y="autoplay ",1==f&&(z="muted "));u=!0;e.hasOwnProperty("disableplayonreappear")&&(u=!e.disableplayonreappear);var B="preload=";B=1==L||1==l||1==v&&""!=y?B+'"metadata" ':B+'"none" ';void 0==e.style&&(e.style=ipcStyleManager.getStyleByName("default",
!0,!1));d={};d.videoTag=n+"_videoplayer";d.videoContainerTag=n+"_ipc_ic";d.isLiveMode=0==l;d.isMobile=f;d.onHide=c;d.onUpdate=k;d.onFitChange=p;d.posterURL=g(e,"poster","");d.disableFullScreen=g(e,"disablefullscreen",!1);d.disableVideoFit=1==g(e,"disablevideofit",!1)||1==browserhelper.isEdge();d.hideLink=g(e,"hidelink",!1);d.audioEnabled=isAudioEnabled;d.snapshotEnabled=!g(e,"disableframecapture",!1);d.enableReportButton=!g(e,"disablereportbutton",!1);d.hideSpeedButton=g(e,"disableplaybackspeedbutton",
!1);d.cameraAlias=e.alias;d.title=g(e,"title",void 0);d.source=r;d.disableDownloadButton=g(e,"disabledownloadbutton",!1);d.setSpeedControlState=a;d.customMenuItem=g(e,"custommenu",void 0);d.style=e.style;d.autoplay=""!=y;d.disableUserPause=g(e,"disableuserpause",!1);d.webSocketVerboseLog=g(e,"websocketverboselog",!1);d.hideContextMenu=g(e,"hidecontextmenu",!1);d.hideControlBar=g(e,"hidecontrolbar",!1);d.stopRightAfterInvisible=g(e,"stoprightafterinvisible",!1);d.streamID=e.streamid;d.disableBufferingAnim=
1==g(e,"disablebufferinganim",!1)||0==e.style.loading.buffering.enabled;d.videoFitMode=g(e,"videofitmode",void 0);d.globalState=void 0==b?{}:b;d.forEnabled=0==g(e,"disableautofullscreen",!1)&&1==f;d.uniqID=g(e,"uniqid",ipcamlivehelper.generateString(8));d.zoomEnabled=!g(e,"disablezoombutton",!1);y="";d.playonscroll={};d.playonscroll.playonscroll=g(e,"playonscroll",!1);d.playonscroll.playonscrolldelay=g(e,"playonscrolldelay",1E3);d.playonscroll.playonscrollstopdelay=g(e,"playonscrollstopdelay",3E3);
d.snippets=e.snippets;1==NATIVE_TEST_WITH_MP4&&(r="http://ipcamlive.com/resources/teststream/VfE_html5.mp4");window.addEventListener("playing",q,!0);window.addEventListener("resize",k);$("#"+n).html("<div id="+n+'_ipc_ic style="width:100%; height:100%; position:relative; background:#000; z-index:1; '+browserhelper.getOverflowValue(e)+'"></div>');f=g(e,"showdebuglog",!1);0==l&&1==f&&browserhelper.createLoggerWindow(n+"_ipc_ic");f="";1==J&&(f=" crossorigin=anonymous");w=$("#"+n+"_ipc_ic");w.append("<video id="+
n+"_videoplayer "+z+y+B+f+' style="width: 100%; height: 100%; background-color: '+e.style.colors.loadingBackground+'; display: block;">Your browser does not capable to play this content.</video>');$("#"+n+"_videoplayer").bind("play",function(){0==l&&F();null!=O&&O()});$("#"+n+"_videoplayer").bind("pause",function(){clearTimeout(K);null!=I&&I()});$("#"+n).width();var G=$("#"+n).height();1==L?(d.playerType=ipc_html5_controls.PlayerTypeWS,x=new ipc_websocket_html5_controls,d=x.attachVideoPlayer(r,d,
h),null!=d&&(m=d)):1==v||1==l?(v=browserhelper.isSafariMobile(),z=$("#"+n+"_videoplayer"),0==v?(d.playerType=ipc_html5_controls.PlayerTypeNative,m=new ipc_html5_controls,m.ipc_attachVideoControls(d),browserhelper.isInlineSupportedOnIPhone()&&z.attr("playsinline","true")):(browserhelper.log("This is safari mobile, ui disabled"),z.attr("poster",d.posterURL),z.attr("controls","true")),z.attr("src",r)):(d.playerType=ipc_html5_controls.PlayerTypeMSE,x=new ipc_hls_html5_controls,m=x.attachVideoPlayer(r,
d));void 0!=m&&(u&&m.set_autoStartAfterPlayerVisibleAgain(),m.set_onControlBarMove(function(a,b){R&&R(a,m.get_controlBarTop());a=$("#"+n+"_logo");if(0!=a.length){if(0==D)if(b=25/C,D=c+E>G-m.get_controlBarHeight()-b,1==D){var c=m.get_controlBarTop()-a.height()-b;a.offset({top:c})}else return;t!=VIDEO_LOGOPOS_TL&&t!=VIDEO_LOGOPOS_TR&&void 0!=a[0]&&(c=m.get_controlBarTop()-a.height()-25/C,$("#"+n+"_logo").offset({top:c}))}}));if(e.onControlsCreated)e.onControlsCreated(m)}}var n,H,J,r,A,t,y=!1,D=!1,u=
0,E=0,B=!1,Q,R,M,K,N,C,x,m,w,G,S,O=null,I=null,L=!1,T=!1,P=void 0;void 0==b&&(b={});this.destroyObjects=function(){e(!1,!0)};this.setCheckStreamState=function(a){M=a};this.player=function(a,b,c){v(a,b,c,!0)};this.resize=function(){k()};this.setEvents=function(a,b){O=a;I=b};this.setOnControlBarUpdateEvent=function(a){R=a};this.setOnFitChangeEvent=function(a){Q=a};this.start=function(){m.doVisibilityChange(!0,0)};this.stop=function(){return m.doVisibilityChange(!1,0)};this.setSource=function(a,b,c){1==
y&&($("#"+n+"_logo").remove(),E=u=0,y=D=!1);m.setSource(a,b,c)};this.getVideoPlayer=function(){return $("#"+n+"_videoplayer")};this.getServerAddress=function(){return H.address};this.getInnerContainerId=function(){return n+"_ipc_ic"};this.getControls=function(){return m};this.setExtraParams=function(a){P=a};this.getWebSocketDelay=function(){return void 0!=x?x.getDelay():0};this.setSnippets=function(a){void 0!=m&&m.setSnippets(a)}}
function iflashvideo(){function b(){l=!0;d()}function d(){if(0==l)dependencyhelper.load_js(ipcamliveHostManager.getHostURL("player/swfobject.js"),b);else{var d=c.source,g="https:"===location.protocol?"skin_https.xml":"skin.xml";$("#"+e).width();$("#"+e).height();var p="MediaPlayer.swf";c.hasOwnProperty("hidelink")&&c.hidelink&&(p="MediaPlayer_DL.swf");var v="HLSPlugin.swf";c.hasOwnProperty("debug")&&c.debug&&(v="HLSPlugin_Debug.swf");d={src:d,autoPlay:"false",plugin_hls:ipcamliveHostManager.getHostURL("player/"+
v),hls_fragmentloadmaxretry:"2",hls_live_flushurlcache:"true",skin:ipcamliveHostManager.getHostURL("player/"+g),javascriptCallbackFunction:"onJavaScriptBridgeCreated"};c.hasOwnProperty("poster")&&(d.poster=c.poster);c.hasOwnProperty("autoplay")&&(d.autoPlay=c.autoplay?"true":"false");c.hasOwnProperty("logo")&&(d.logo=c.logo);c.hasOwnProperty("logopos")&&(d.logoPosition=c.logopos);c.hasOwnProperty("autostopaftersec")&&(d.autoStopAfterSec=c.autostopaftersec);c.hasOwnProperty("mute")&&c.mute&&(d.muted=
...
function ipc_html5_controls(){function Oa(){y=0==b.disableVideoFit&&!0==="objectFit"in document.documentElement.style;1==y&&void 0!==b.videoFitMode&&(c.css("object-fit",b.videoFitMode),v=!0,y=!1);var a=l(m,"bigPlay",["bigPlayBase"]);1==b.autoplay&&a.hide();ipcStyleManager.setBackgroundImage(a,b.style.playButton.bitmap,b.style);b.forEnabled&&(a=l(m,"rofAnim",["bigPlayBase"]),a.hide(),ipcStyleManager.setBackgroundImage(a,b.style.fullscreenOnRotate.bitmap,b.style));if(0==b.hideControlBar){var e=q(m,
"control");ipcStyleManager.setPanelStyle(e,b.style);if(b.isLiveMode)a=b.isMobile?l(e,"progressDiv",["meterMobile","stripes"]):l(e,"progressDiv",["meter","stripes"]),a.append('<span style="width: 100%"></span>'),ipcStyleManager.applyProgressBarStyle(e,b.style.colors.main,b.style.colors.mainDark,.5),ipcStyleManager.applyProgressBarStyle(a,b.style.colors.main,b.style.colors.mainDark,.5);else{a=q(e,"progressDiv","progress");var f=ra(a,"bufferBar");a=ra(a,"timeBar");ipcStyleManager.setBackgroundColor(f,
"#777");ipcStyleManager.setBackgroundColor(a,b.style.colors.main)}f=q(e,"btmControl");0==b.disableUserPause&&(t=l(f,"btnPlay",["btnPlay","controlBtn"],ipcLocale.playButtonHint));0==b.disableFullScreen&&(a=sa()?ipcLocale.fullScreenButtonHint:ipcLocale.fullScreenUnavailable,l(f,"btnFS",["btnFS","controlBtn"],a));1==y&&l(f,"btnFit",["btnFit","controlBtn"],ipcLocale.fitButtonHint);0==b.disableDownloadButton&&l(f,"btnDownload",["btnDownload","controlBtn-2"],ipcLocale.downloadTimelapseHint);1==b.zoomEnabled&&
l(f,"btnZoom",["btnEnableZoom","controlBtn-2"],ipcLocale.zoomButtonHint);1==b.snapShotEnabled&&l(f,"snapShot",["snapShot","controlBtn"],ipcLocale.downloadSnapshotHint);1==b.enableReportButton&&l(f,"btnReport",["btnReport","controlBtn"],ipcLocale.reportContent);1==b.audioEnabled&&(a=q(f,"volume",void 0,ipcLocale.volumeButtonHint),ra(a,"volumeBar"),l(f,"btnSound",["btnSound","controlBtn"],ipcLocale.muteButtonHint));1==b.isLiveMode?(a=l(e,"liveText",["liveText","defaultFont"],ipcLocale.live),1==b.disableUserPause&&
a.css("padding-left","5px"),l(e,"wsText",["liveText","defaultFont"],ipcLocale.webSocketHint,ipcLocale.webSocketPostFix).hide()):(l(e,"timeText",["timeText","defaultFont"],"0.0/0.0"),0==b.isMobile&&0==b.hideSpeedButton&&(l(e,"playbackBtn",["playbackBtn","defaultFont"],ipcLocale.playbackSpeedButtonHint,"1x"),rb()));l(e,"hdIcon",["hdIcon","controlBtn"],ipcLocale.hdStream)}if(0==b.disableBufferingAnim){a=q(m,"loadingSpinnerContainer");var g=q(a,"loadingSpinnerDefault");0==b.style.loading.buffering.showBackgroundPanel&&
(a[0].style.background="rgba(0, 0, 0, 0.0)",a[0].style.borderColor="rgba(0, 0, 0, 0.0)");g[0].style.backgroundImage=ipcStyleManager.getBitmapURL(b.style.loading.buffering.anim);g[0].style.filter=ipcStyleManager.buildFilters(b.style.filters)}void 0!=b.title&&(a=q(m,"titleBar","control"),q(a,"titleText",void 0,void 0,b.title));0==b.hideControlBar&&(ipcStyleManager.applyBaseImage(f,h("controlBtn"),b.style.icons.bitmap1,b.style),ipcStyleManager.applyBaseImage(f,h("controlBtn-2"),b.style.icons.bitmap2,
b.style),ipcStyleManager.applyFontStyle(e,h("defaultFont"),b.style));b.isLiveMode||sb();tb(1);c.on("play",Pa);c.on("pause",ta);if(b.isMobile)c.on("touchend",ca),screen&&screen.orientation&&screen.orientation.addEventListener("change",Qa);else c.on("click",ca);c.on("ended",Ra);c.on("canplay",Sa);c.on("loadedmetadata",ua);c.on("playing",Ta);c.on("waiting",Ua);window.addEventListener("resize",E);ub();vb();wb();xb();yb();zb();Ab();Bb();b.isMobile||(1==b.hideContextMenu?Cb():Db());0==b.hideControlBar&&
(d("control").show().css({bottom:-28}),I());void 0!=b.title&&(d("titleBar").show().css({top:0}),d("titleBar").css("height","40px"),d("titleBar").show());z=new ipc_snippet_mgr;z.init(b);"undefined"!==typeof document.hidden?(J="hidden",F="visibilitychange"):"undefined"!==typeof document.mozHidden?(J="mozHidden",F="mozvisibilitychange"):"undefined"!==typeof document.msHidden?(J="msHidden",F="msvisibilitychange"):"undefined"!==typeof document.webkitHidden&&(J="webkitHidden",F="webkitvisibilitychange");
"undefined"!==typeof document.addEventListener&&"undefined"!==typeof document[J]&&document.addEventListener(F,Va,!1);1==b.autoplay&&""!=b.source?va():1==b.playonscroll.playonscroll&&0==b.isMobile&&Eb();1==Wa&&0==Xa&&ua();b.forEnabled&&(k.mgr=new ipc_for_mgr,k.mgr.init(b.uniqID,m[0],Fb))}function Ya(){k.mgr&&(k.mgr.done(),k.mgr=void 0);dependencyhelper.remove_item_cb(wa,Za);clearInterval(K);L();null!=w&&(window.clearInterval(w),w=null);M();da();d("control").remove();d("bigPlay").remove();b.forEnabled&&
d("rofAnim").remove();d("playbackSpeedsDiv").remove();0==b.disableBufferingAnim&&d("loadingSpinnerContainer").remove();void 0!=b.title&&d("titleBar").remove();m.off("mousemove",$a);c.off("play",Pa);c.off("pause",ta);b.isMobile?(c.off("touchend",ca),screen&&screen.orientation&&screen.orientation.removeEventListener("change",Qa)):c.off("click",ca);c.off("ended",Ra);c.off("canplay",Sa);c.off("loadedmetadata",ua);c.off("loadstart",Gb);c.off("playing",Ta);c.off("waiting",Ua);c.off("loadedmetadata",ab);
window.removeEventListener("resize",E);document.removeEventListener(F,Va);null!=xa&&xa.destroy();N=!1;1==v&&(v=!1,bb())}function Fb(a,b){ya()||(k.canShow=a,0==k.canShow&&ea())}function Eb(){A=!1;$(window).scroll(function(){c.is(":in-viewport")?(da(),1!=fa&&(fa=!0,null==O&&c[0].paused&&G(!0,b.playonscroll.playonscrollstopdelay,b.playonscroll.playonscrolldelay,!1))):(M(),0!=fa&&(fa=!1,null==P&&0==c[0].paused&&G(!1,b.playonscroll.playonscrollstopdelay,b.playonscroll.playonscrolldelay,!1)))})}function Cb(){c.on("contextmenu",
function(a){a.preventDefault()})}function Db(){var a=2;switch(b.playerType){case ipc_html5_controls.PlayerTypeNative:var e=1==b.hideLink?{title:ipcLocale.html5PlayerNative,data:{disabled:!0}}:{title:"IPCamLive "+ipcLocale.html5PlayerNative,data:{disabled:!0}};var c=[{title:"ipcamlive.com",data:function(a,b){window.open("https://ipcamlive.com")}},$.contextMenu.separator,e,{title:ipcLocale.liveStreaming,data:{disabled:!0}},$.contextMenu.separator,{title:ipcLocale.reportContent,data:function(a,b){ha()}}];
break;case ipc_html5_controls.PlayerTypeMSE:e=1==b.hideLink?{title:ipcLocale.html5PlayerMSE,data:{disabled:!0}}:{title:"IPCamLive "+ipcLocale.html5PlayerMSE,data:{disabled:!0}};c=[{title:"ipcamlive.com",data:function(a,b){window.open("https://ipcamlive.com")}},$.contextMenu.separator,e,{title:ipcLocale.liveStreaming,data:{disabled:!0}},$.contextMenu.separator,{title:ipcLocale.reportContent,data:function(a,b){ha()}}];break;case ipc_html5_controls.PlayerTypeWS:e=1==b.hideLink?{title:ipcLocale.html5PlayerWebSocket,
data:{disabled:!0}}:{title:"IPCamLive "+ipcLocale.html5PlayerWebSocket,data:{disabled:!0}},c=[{title:"ipcamlive.com",data:function(a,b){window.open("https://ipcamlive.com")}},$.contextMenu.separator,e,{title:ipcLocale.liveStreaming,data:{disabled:!0}},$.contextMenu.separator,{title:ipcLocale.reportContent,data:function(a,b){ha()}}]}1==b.hideLink&&(a=0,c.shift(),c.shift());0==b.enableReportButton&&(c.pop(),c.pop());void 0!=b.customMenuItem&&c.splice(a,0,{title:b.customMenuItem.text,data:function(a,
e){window.open(b.customMenuItem.link)}});$(function(){xa=m.contextMenu(c,{theme:"vista"});$(".context-menu-item").hover(function(){0==$(this).hasClass("context-menu-item-disabled")&&$(this).css("background-color",b.style.colors.main)},function(){$(this).css("background-color","#FAFAFA")})})}function rb(){var a=q(m,"playbackSpeedsDiv");if(void 0!=a){for(var e=d("playbackBtn"),f=Q.length-1;0<=f;f--){var g=b.videoContainerTag+"_"+("pbBtn"+f);a.append('<div class="'+h("playbacSpeedBtn")+" "+h("defaultFont")+
'" data-index="'+f+'" id="'+g+'">'+Q[f]+"x</div>");d("pbBtn"+f).on("click",function(){var a=this.getAttribute("data-index");e.text(Q[a]+"x");c[0].playbackRate=Q[a];za()})}e.hover(function(){a.css("width",$("."+h("playbacSpeedBtn")).width()+"px");a.css("height",Q.length*$("."+h("playbacSpeedBtn")).height()+"px");var b=d("playbackBtn").position().left,e=d("control").position().top,c=d("playbackBtn").width(),f=a.width(),g=a.height();a.css("left",b+c/2-f/2+"px");a.css("top",e-g+"px");cb()},function(){R=
setTimeout(za,50)});a.hover(function(){cb()},function(){R=setTimeout(za,50)});ipcStyleManager.applyFontStyle(a,h("defaultFont"),b.style)}}function $a(){c[0].paused||B(3E3)}function ab(){Wa=!0}function ua(){Xa=!0;E();setTimeout(Aa,150);if(!b.isMobile){m.hover(function(){c[0].paused||B(3E3)},function(){S||ia(!1)});m.on("mousemove",$a);var a=d("control");void 0!=a&&a.hover(function(){T=!0},function(){T=!1})}1==b.autoplay&&C(!1)}function Pa(){ja=ka=!0;void 0!=t&&t.addClass(h("paused"));d("bigPlay")[0].style.opacity=
1;d("bigPlay").hide();A=!1;p(!0)}function ta(){if(0==A){if(void 0!=document.visibilityState&&"hidden"==document.visibilityState)return;U(ipc_html5_controls.ButtonStateNormal);d("bigPlay").show();la();L()}p(!0)}function Sa(){}function Ra(){void 0!=t&&t.removeClass(h("paused"));c[0].pause()}function ca(a){1!=p(!0)&&(a&&"select"!=a.target.localName&&a.preventDefault(),void 0!=Ba&&1==Ba(this)||1==ipc_contextMenuShown||V()||(d("bigPlay").is(":visible")?d("bigPlay").click():(ma(),b.isMobile?(c[0].paused&&
void 0==g.mgr&&c[0].play(),na?ia(!1):B(3E3)):(A=!0,void 0==g.mgr&&C(),B(3E3)))))}function Gb(){C();B(3E3)}function Ta(){ja=ka=!0;E()}function Ua(){ka=!1}function U(a){var b=d("bigPlay");switch(a){case ipc_html5_controls.ButtonStateNormal:b.css("background-position","0px 0px");break;case ipc_html5_controls.ButtonStateSelected:b.css("background-position",-b.width()+"px 0px")}}function wb(){d("bigPlay").on("click",function(a,e){V()&&void 0==e||(M(),1!=ipc_contextMenuShown&&(void 0!=b.onFirstPlay&&null!=
b.onFirstPlay&&(b.onFirstPlay(),b.onFirstPlay=null),U(ipc_html5_controls.ButtonStateSelected),C(db),B(3E3)))});d("bigPlay").hover(function(){V()||U(ipc_html5_controls.ButtonStateSelected)},function(){V()||U(ipc_html5_controls.ButtonStateNormal)});if(void 0!=t)t.on("click",function(){V()||(A=!0,C())});1==Ca?eb():Da();E()}function E(){if(0!=c[0].clientWidth){0==b.disableBufferingAnim&&ipcamlivehelper.resizeElement(c[0],d("loadingSpinnerContainer"),b.style.loading.buffering,b.style.loading.limits);ipcamlivehelper.resizeElement(c[0],
d("bigPlay"),b.style.playButton,b.style.playButton,!0);b.forEnabled&&ipcamlivehelper.resizeElement(c[0],d("rofAnim"),b.style.fullscreenOnRotate,b.style.fullscreenOnRotate,!0,ElementPositions.BOTTOM);var a=d("volume");300>c[0].clientWidth?a.hide():a.show();I();null!=D&&D();fb(!0);void 0!=n&&gb();z&&z.resize()}}function ya(){if(void 0!=screen&&void 0!=screen.orientation){var a=(screen.orientation||{}).type||screen.mozOrientation||screen.msOrientation;return"landscape-primary"==a||"landscape-secondary"==
a?!0:!1}}function Qa(a){void 0!=k.canShow&&0!=k.canShow&&0!=ja&&(a=ya(),void 0!=a&&(a?null==Ea()&&(ea(!0),d("btnFS").click()):Ea()&&d("btnFS").click()))}function Ea(){return document.webkitFullscreenElement||document.mozFullscreenElement||document.msFullscreenElement||document.fullscreenElement}function sa(){return void 0!=document.webkitFullscreenEnabled?document.webkitFullscreenEnabled:void 0!=document.mozFullscreenEnabled?document.mozFullscreenEnabled:void 0!=document.msFullscreenEnabled?document.msFullscreenEnabled:
void 0!=document.fullscreenEnabled?document.fullscreenEnabled:!0}function hb(){sa()&&(Ea()?d("btnFS").addClass(h("exitFS")):d("btnFS").removeClass(h("exitFS")))}function ub(){sa()?(hb(),d("btnFS").click(function(){void 0!=g.mgr&&ib();p(!0);if($.isFunction(x[0].webkitRequestFullScreen))null==document.webkitFullscreenElement?x[0].webkitRequestFullScreen():document.webkitCancelFullScreen();else if($.isFunction(x[0].mozRequestFullScreen))null==document.mozFullscreenElement?x[0].mozRequestFullScreen():
document.mozCancelFullScreen();else if($.isFunction(x[0].msRequestFullscreen))null==document.msFullscreenElement?x[0].msRequestFullscreen():document.msExitFullscreen();else if($.isFunction(x[0].requestFullScreen))null==document.fullscreenElement?x[0].requestFullScreen():document.cancelFullScreen();else if($.isFunction(c[0].webkitEnterFullScreen))0==c[0].webkitDisplayingFullscreen?c[0].webkitEnterFullScreen():c[0].webkitCancelFullScreen();else{alert("Your browsers doesn't support fullscreen");return}u();
if(is.safari()&&b.onUpdate)b.onUpdate(0)}),document.addEventListener("fullscreenchange",oa),document.addEventListener("webkitfullscreenchange",oa),document.addEventListener("mozfullscreenchange",oa),document.addEventListener("MSFullscreenChange",oa)):(d("btnFS").removeClass(h("controlBtn")),d("btnFS").removeClass(h("btnFS")),d("btnFS").addClass(h("disabledFS")))}function oa(){hb()}function Bb(){var a=new Image;a.onload=function(){Fa=a.width;Ga=a.height;browserhelper.log("PosterSize: "+Fa+"x"+Ga);
E();1==c[0].paused&&c[0].setAttribute("poster",b.posterURL)};a.src=b.posterURL}function fb(a){if(1==y&&0==b.disableVideoFit){var e=c[0].videoWidth,f=c[0].videoHeight;0==e&&(e=Fa);0==f&&(f=Ga);if(0!=e||0!=e)e/=f,1==a&&(.01<Math.abs(e-c[0].clientWidth/c[0].clientHeight)?d("btnFit").show():d("btnFit").hide()),.8>Math.abs(e-c[0].clientWidth/c[0].clientHeight)?(0==N&&0==v&&Ha(),N=!0):(1==N&&1==v&&Ha(),N=!1)}}function bb(){0!=y&&(v?(d("btnFit").addClass(h("exitFit")),c.css("object-fit","fill")):(d("btnFit").removeClass(h("exitFit")),
c.css("object-fit","contain")))}function Ha(){0!=y&&(v=!v,bb())}function vb(){0==y&&0==b.disableVideoFit?browserhelper.log("Video Fit not supported!"):(d("btnFit").hide(),d("btnFit").hide(),d("btnFit").click(function(){p(!0);Ha();u();if(b.onUpdate)b.onUpdate();if(b.onFitChange)b.onFitChange(v)}))}function xb(){if(0!=b.snapShotEnabled){var a=d("snapShot");a.show();a.click(function(){p(!0);u();captureFrameHelper.captureFrame(c[0],"SnapShot")})}}function yb(){if(0!=b.enableReportButton){var a=d("btnReport");
a.show();a.click(function(){p(!0);u();ha()})}}function ha(){void 0!=b.cameraAlias&&(browserhelper.forceLog("Report inappropriate content: https://ipcamlive.com/reportabuse?alias="+b.cameraAlias),window.open("https://ipcamlive.com/reportabuse?alias="+b.cameraAlias))}function zb(){if(1!=b.disableDownloadButton){var a=d("btnDownload");a.show();a.click(function(a){p(!0);u();var e=c[0].src;a=document.createElement("a");var d="";void 0!=b.cameraAlias&&(d=b.cameraAlias);void 0!=W&&""!=W&&(""!=d&&(d+="_"),
d+=W.toLowerCase());""==d&&(d="video");d+=".mp4";a.setAttribute("href",e);a.setAttribute("download",d);document.createEvent?(e=document.createEvent("MouseEvents"),e.initEvent("click",!0,!0),a.dispatchEvent(e)):a.click&&a.click()})}}function Ab(){0!=b.zoomEnabled&&d("btnZoom").click(function(a){p(!0);u();ib()})}function ib(){function a(){g.fadeTimer&&clearTimeout(g.fadeTimer);g.fadeTimer=setTimeout(function(){g.labelDiv.fadeOut(500);g.labelVisible=!1;g.fadeTimer=void 0},1500)}void 0==g.mgr?(g.mgr=
Panzoom(c[0],{step:.25,maxZoom:4,minZoom:1,contain:"outside"}),m[0].addEventListener("wheel",g.mgr.zoomWithWheel),d("btnZoom").addClass(h("btnDisableZoom")),g.labelDiv=q(m,"zoomTextDiv"),g.label=l(g.labelDiv,"zoomText",["zoomText","noselect"]),g.labelDiv.hide(),g.labelVisible=!1,g.lastScale=0,c[0].addEventListener("panzoomchange",function(b){if(!(1E-4>Math.abs(g.lastScale-b.detail.scale))){g.lastScale=b.detail.scale;g.label.text(b.detail.scale.toFixed(2)+" x");b=m.width()/2-30;var c=m.height()/2-
15;g.labelDiv.css({left:b,top:c});0==g.labelVisible&&(g.labelVisible=!0,g.labelDiv.fadeIn(500));a()}}),setTimeout(function(){g.mgr.zoom(1.5,{animate:!0})},1)):(g.labelDiv.remove(),d("btnZoom").removeClass(h("btnDisableZoom")),m[0].removeEventListener("wheel",g.mgr.zoomWithWheel),g.mgr.zoom(1,{animate:!0}),g.mgr.reset(),g.mgr.destroy(),g.mgr=null,c[0].style.cursor="")}function C(a){if(c[0].paused||c[0].ended){if(0==b.disableUserPause&&void 0!=t&&t.addClass(h("paused")),void 0==a||0==a){var e=c[0].play();
va();void 0!==e&&e.then(function(){X=!0}).catch(function(e){browserhelper.forceLog("The browser is prevent to play video automatically. Error: "+e);1==b.audioEnabled&&0==c[0].muted?(browserhelper.forceLog("Try with muted audio."),c[0].muted=!0,C(a)):(browserhelper.forceLog("Also failed with muted audio."),b.onFirstPlay=null,X=!1,$(window).scroll(void 0),window.setTimeout(function(){L();la();G(!1,0,0,!0);Da();d("bigPlay").show()},150))})}}else 0==b.disableUserPause&&(void 0!=t&&t.removeClass(h("paused")),
c[0].pause(),L());b.isLiveMode&&(c[0].paused?d("liveText").text(ipcLocale.paused):d("liveText").text(ipcLocale.live))}function I(){var a=d("control");void 0!=a&&a.offset()&&(jb=a.offset().top)}function B(a){na||(na=!0,d("control").stop().animate({bottom:0},{duration:500,step:function(a,b){I();null!=D&&D(a,b)}}),void 0!=b.title&&d("titleBar").stop().animate({top:0},{duration:500}));null!=w&&(window.clearInterval(w),w=null);0<a&&(w=window.setInterval(function(){ia(!1)},a))}function ia(a){if(0!=a||!c[0].paused&&
!T)a=1==a?0:500,d("control").stop().animate({bottom:-28},{duration:a,step:function(a,b){I();null!=D&&D(a,b)}}),void 0!=b.title&&d("titleBar").stop().animate({top:-40},{duration:a}),na=!1,kb(),lb()}function u(){b.isMobile&&B(3E3)}function kb(){null!=w&&(window.clearInterval(w),w=null)}function mb(a){b.setSpeedControlState&&b.setSpeedControlState(d("playbackSpeedsDiv"),a)}function za(){R=null;d("playbackSpeedsDiv").hide();T=!1;b.isMobile&&B(3E3);mb(!1)}function cb(){T=!0;null!=R&&clearTimeout(R);d("playbackSpeedsDiv").show();
kb();mb(!0)}function nb(){if(1!=k.final&&1!=b.globalState.forEnded&&void 0!=k.canShow&&0!=k.canShow){var a=ya();void 0!=a&&1!=a&&(a=d("rofAnim"),0!=a.length&&(void 0==k.firstShow?k.waitTimer||(k.waitTimer=setTimeout(function(){k.firstShow=!1;1!=k.suspended&&nb()},1500)):(void 0==k.hideTimer&&(k.hideTimer=setTimeout(function(){ea(!0)},5E3)),k.suspended=!1,b.globalState.forEnded=!0,z.hideSnippetsByElement(a,0,500),k.visible=!0,a.delay(500).fadeIn(500))))}}function ea(a){if(1==k.visible&&1!=k.final){var b=
d("rofAnim");0!=b.length&&(void 0!=a?k.final=a:void 0!=k.firstShow&&(k.suspended=!0),k.visible=!1,b.fadeOut(500),z.showHidedSnippets(1E3,500))}}function Ia(){0==b.disableBufferingAnim&&0==pa&&(ea(),d("loadingSpinnerContainer").fadeIn(100),pa=!0)}function la(){0==b.disableBufferingAnim&&1==pa&&(d("loadingSpinnerContainer").fadeOut(100),pa=!1);nb()}function va(){L();qa=window.setInterval(function(){1==Ja?1==ka?la():Ia():0==Y?(Z=c[0].currentTime,Y=Date.now(),0==Z&&Ia()):Z!=c[0].currentTime?(Z=c[0].currentTime,
Y=Date.now(),la()):3E3<=Date.now()-Y&&Ia()},500)}function L(){null!=qa&&(window.clearTimeout(qa),qa=null,Y=Z=0)}function h(a){return"ipc-"+a}function d(a){return $("#"+(b.videoContainerTag+"_"+a))}function q(a,c,f,g,k){var e="<div id="+(b.videoContainerTag+"_"+c);e=void 0==f?e+' class="'+h(c)+'"':e+' class="'+h(f)+'"';void 0!=g&&(e=e+' title="'+g+'"');e+=">";void 0!=k&&(e+=k);a.append(e+"</div>");return d(c)}function l(a,c,f,g,k){for(var e=' class="',l=0;l<f.length;l++)e+=h(f[l]),e=l==f.length-1?
e+'"':e+" ";f="<div id="+(b.videoContainerTag+"_"+c)+e;void 0!=g&&(f=f+' title="'+g+'"');f+=">";void 0!=k&&(f+=k);a.append(f+"</div>");return d(c)}function ra(a,c,f){void 0==f?a.append("<span id="+(b.videoContainerTag+"_"+c)+' class="'+h(c)+'"></span>'):a.append("<span id="+(b.videoContainerTag+"_"+c)+' class="'+h(f)+'"></span>');return d(c)}function M(){null!=O&&(window.clearInterval(O),O=null)}function da(){null!=P&&(window.clearInterval(P),P=null)}function G(a,e,f,g){M();da();if(!b.isReembedAvailable||
0!=b.isReembedAvailable())if(!a)P=window.setInterval(function(){da();c[0].paused||(browserhelper.log("Stop playing due player is invisible."),C());if(0!=b.isLiveMode&&(b.autoplay=!1,ia(!0),ta(),(1==ja||1==g)&&b.onHide)){var a=b.onHide();void 0!=a&&a.setPauseComeFromUser(A)}},e);else if(X&&c[0].paused&&0==A)browserhelper.log("Start playing due player is visible again."),ipcamlivehelper.createTimeout(function(){1==c[0].paused&&(d("bigPlay").show(),d("bigPlay").fadeOut(f-150))},100),O=window.setInterval(function(){M();
if(0!=c[0].paused&&(d("bigPlay").trigger("click",["force"]),b.onShow))b.onShow(!0)},f);else if(X&&c[0].paused&&b.onShow)b.onShow(!1)}function Va(a){G("hidden"!==document.visibilityState,1==b.stopRightAfterInvisible?250:1E4,2E3,!1)}function Za(){Oa()}function Ka(){d("btnSound").removeClass(h("sound")).removeClass(h("sound2")).addClass(h("muted"));c[0].muted?d("volumeBar").css("width",0):aa(0,c[0].volume)}function tb(a){d("volume").on("mousedown",function(a){S=!0;c[0].muted=!1;aa(a.pageX);u()});$(document).on("mouseup",
function(a){S&&(S=!1,aa(a.pageX),u())});$(document).on("mousemove",function(a){S&&(aa(a.pageX),u())});d("btnSound").click(function(){c[0].muted=!c[0].muted;p(!0);ma();Ka();u()});aa(0,a)}function aa(a,b){var e=d("volume");a=b?100*b:100*(a-e.offset().left)/e.width();100<a?a=100:0>a&&(a=0);d("volumeBar").css("width",a+"%");c[0].volume=a/100;0==c[0].volume?d("btnSound").removeClass(h("sound")).removeClass(h("sound2")).addClass(h("muted")):.5<c[0].volume?d("btnSound").removeClass(h("muted")).removeClass(h("sound")).addClass(h("sound2")):
d("btnSound").removeClass(h("muted")).removeClass(h("sound2")).addClass(h("sound"))}function ob(){1!=ba&&(ba=!0,d("progressDiv").animate({height:10},{duration:150,step:function(a,b){d("control").css("height",28+a-3+"px")}}))}function lb(){0!=ba&&(ba=!1,d("progressDiv").animate({height:3},{duration:150,step:function(a,b){d("control").css("height",28+a-3+"px")}}))}function sb(){var a=!1;0==b.isMobile&&d("progressDiv").hover(function(){ob()},function(){lb()});d("progressDiv").on("mousedown",function(c){1==
b.isMobile&&0==ba&&ob();a=0==b.isMobile;La(c.pageX);u()});$(document).on("mouseup",function(b){a&&(a=!1,La(b.pageX))});$(document).on("mousemove",function(b){a&&La(b.pageX)});c.on("timeupdate",function(){var a=c[0].currentTime,b=c[0].duration,g=100*a/b;d("timeBar").css("width",g+"%");pb(a,b)});pb(0,c[0].duration)}function La(a){var b=d("progressDiv"),f=c[0].duration;a=100*(a-b.offset().left)/b.width();100<a&&(a=100);0>a&&(a=0);d("#timeBar").css("width",a+"%");c[0].currentTime=f*a/100}function Aa(){if(0==
c[0].buffered.length)setTimeout(Aa,500);else{var a=c[0].duration,b=c[0].buffered.end(0),f=100*b/a;d("bufferBar").css("width",f+"%");b<a&&setTimeout(Aa,500)}}function pb(a,b){a=qb(a);b=qb(b);""!=a&&""!=b?d("timeText").text(a+" / "+b):d("timeText").text("")}function qb(a){var b=10>Math.floor(a/60)?"0"+Math.floor(a/60):Math.floor(a/60);a=10>Math.floor(a-60*b)?"0"+Math.floor(a-60*b):Math.floor(a-60*b);return isNaN(b)||isNaN(a)?"":b+":"+a}function V(){return d("bigPlay").length?1>d("bigPlay")[0].style.opacity?
!0:!1:!0}function eb(){d("bigPlay")[0].style.opacity=.5}function Da(){d("bigPlay").length&&(U(ipc_html5_controls.ButtonStateNormal),d("bigPlay")[0].style.opacity=1);p(!0)}function ma(){void 0!=r&&r.stop().animate({opacity:0},{duration:250,complete:function(){r.remove()}})}function p(a){1==a&&clearInterval(K);if(void 0==n)return!1;n.stop().animate({opacity:0},{duration:250,complete:function(){n.remove();n=void 0}});return!0}function gb(){if(1!=c[0].paused){void 0==n&&(H=15,n=l(m,"alreadyWatchDiv",
["unmuteButton"]),n.css("opacity",0),l(n,"alreadyViewText",["alreadyViewText","noselect"]).text(ipcLocale.alreadyViewing),l(n,"countDownText",["alreadyViewText","noselect"]).text(ipcLocale.playingWillStop+" "+H),n.stop().animate({opacity:1},{duration:250}),n.on("click",function(){p(!0)}),clearInterval(K),K=setInterval(function(){d("countDownText").text(ipcLocale.playingWillStop+" "+H);H--;0==H?p(!1):0>H&&(clearInterval(K),b.onHide())},1E3));var a=.6*c[0].clientWidth;320<a&&(a=320);n.width(a);textFit(n[0],
{minFontSize:1,maxFontSize:20,multiLine:!1,alignHoriz:!0,alignVert:!0,widthOnly:!0});n.height(n[0].children[0].style.height);a=c[0].clientWidth/2-n.width()/2;var e=c[0].clientHeight/2-n.height()/2;n.offset({left:a,top:e})}}var b=null,c=null,m=null,x=null,v=!1,A=!0,jb=0,y=!0,xa=null,Ca=!1,N=!1,ba=!1,ka=!1,ja=!1,W=void 0,db=!1,Ba=void 0,wa=void 0,Wa=!1,Xa=!1,Fa=0,Ga=0,Ma=0,Na=0,w=null,na=!1,T=!1,t=void 0,Q=[.5,1,1.5,2],R=null,J=null,F=null,P=null,O=null,D=null,fa=void 0,X=!1,qa=null,pa=!1,Z=0,Y=0,Ja=
!1,S=!1,r=void 0,n=void 0,K=void 0,H=0,z=void 0,k={},g={};this.ipc_attachVideoControls=function(a){b={};$.extend(b,a);a=browserhelper.isMobileBrowser();b.snapShotEnabled=b.snapshotEnabled&&captureFrameHelper.isSupported();b.audioEnabled=1==b.audioEnabled&&1==b.isLiveMode;b.disableDownloadButton=b.disableDownloadButton||a||1==b.isLiveMode;c=$("#"+b.videoTag);x=m=$("#"+b.videoContainerTag);c.on("loadedmetadata",ab);Ja=is.chrome()&&a&&57==parseInt(platform.version);1==Ja&&browserhelper.log("Chrome 57 on mobile detected. Video.currentTime property is broken, use workaround.");
wa=ipcamliveHostManager.getHostURL(dependencyhelper.createVersionedCSSFileName("player/html5player/ipcamliveplayer",IPC_PLAYER_CCS_VERSION));dependencyhelper.load_css(wa,Za)};this.ipc_detachVideoControls=function(){Ya()};this.doPlay=function(){C(!1)};this.getClass=function(a){return h(a)};this.hidePlay=function(){d("bigPlay").length?eb():Ca=!0};this.showPlay=function(){Ca=!1;Da()};this.showLoadingSpinner=function(){va()};this.get_video=function(){return c};this.get_isVideoFit=function(){return v};
this.get_controlBarTop=function(){I();return jb};this.get_controlBarHeight=function(){return 28};this.set_onControlBarMove=function(a){D=a};this.set_HDState=function(a){var b=d("hdIcon");1==a?b.show():b.hide()};this.set_WSState=function(a){var b=d("wsText");1==a?b.show():b.hide()};this.set_showLiveResolution=function(a){if(0!=b.isLiveMode)if(1==a)c.on("timeupdate",function(){if(0==Na||1E3<=Date.now()-Na)Na=Date.now(),Ma!=c[0].videoHeight&&(Ma=c[0].videoHeight,d("liveText").text(ipcLocale.live+" ("+
Ma+"p)"))});else c.off("timeupdate")};this.set_doNotStartOnBigPlay=function(){db=!0};this.set_autoStartAfterPlayerVisibleAgain=function(){X=!0};this.set_onFirstPlay=function(a){b.onFirstPlay=a};this.doVisibilityChange=function(a,b){if(a)return G(a,b,2E3,!1),!0;if(c[0].paused)return!1;G(a,b,2E3,!1);return!0};this.setSource=function(a,d,f){Ya();b.source=a;b.posterURL=d;Oa();c[0].src=a;W=f};this.setSourceName=function(a){W=a};this.overrideFullscreenElement=function(a){x=a};this.setDiscardClickEvent=
function(a){Ba=a};this.setPauseComeFromUser=function(a){A=a};this.updateFit=function(){fb(!1)};this.setUnmuteButton=function(a){void 0==r&&(r=q(m,"unmuteButton"),r.css("opacity",0),q(r,"unmuteImage"),ipcStyleManager.applyBaseImage(r,h("unmuteImage"),b.style.icons.bitmap1,b.style),l(r,"unmuteText",["unmuteText","noselect"]).text(ipcLocale.unmute),r.stop().animate({opacity:1},{duration:250}),r.on("click",function(){ma();c&&c[0]&&(c[0].muted=!1,Ka())}),setTimeout(function(){ma()},3E4),Ka());r.offset(a)};
this.setSnippets=function(a){z&&z.setSnippets(a)};this.showContinueWatchMessage=function(){gb()}}ipc_html5_controls.PlayerTypeNative=1;ipc_html5_controls.PlayerTypeMSE=2;ipc_html5_controls.PlayerTypeWS=3;ipc_html5_controls.ButtonStateNormal=1;ipc_html5_controls.ButtonStateSelected=2;
...
function ipc_snippet_mgr(){function l(a,b){if(b.type==snippetPositionType.pixel)return b.value;if(b.type==snippetPositionType.percent)return b.align==snippetAlignType.horizontal?b.value/100*a.clientWidth:b.value/100*a.clientHeight}function p(a,b){var c=0,d=0,g=l(b,a.size.x),e=l(b,a.size.y);switch(a.align.horizontalAlign){case snippetHorizontalAlign.left:c=0;break;case snippetHorizontalAlign.center:c=b.clientWidth/2-g/2;break;case snippetHorizontalAlign.right:c=b.clientWidth-g}switch(a.align.verticalAlign){case snippetVerticalAlign.top:d=
0;break;case snippetVerticalAlign.center:d=b.clientHeight/2-e/2;break;case snippetVerticalAlign.bottom:d=b.clientHeight-e}var f=l(b,a.padding.leftTop.x);var h=l(b,a.padding.leftTop.y);var k=l(b,a.padding.rightBottom.x);a=l(b,a.padding.rightBottom.y);c<f&&(c+=f-c);d<h&&(d+=h-d);c+g>b.clientWidth-k&&(k=c+g-(b.clientWidth-k),c>f&&(f=Math.min(c-f,k),c-=f,k-=f),0<k&&(g-=k));d+e>b.clientHeight-a&&(k=d+e-(b.clientHeight-a),d>h&&(b=Math.min(d-h,k),d-=b,k-=b),0<k&&(e-=k));return{left:c,top:d,width:g,height:e}}
...
f}switch(a.align.verticalAlign){case snippetVerticalAlign.top:d=0;break;case snippetVerticalAlign.center:d=h/2;break;case snippetVerticalAlign.bottom:d=h}}a.div.css({left:b.left+c,top:b.top+d,width:g,height:e})}}function r(a){if(void 0!=a){m=[];e=[];for(var b=0;b<a.length;b++){var c={};$.extend(!0,c,a[b]);void 0!=c.snippet&&""!=c.snippet&&(ipcamlivehelper.isURL(c.snippet)&&(c.snippet='<iframe src="'+c.snippet+'" style="border:none; width: 100%; height: 100%"></iframe>'),e.push(c))}}}function t(){var a=
new htmlEditHelperClass;a.setContainerName(n.videoContainerTag);for(var b=$("#"+n.videoContainerTag),c=0;c<e.length;c++){var d=e[c];d.responsiveContent=void 0!=d.responsiveContent?d.responsiveContent:!0;d.div=a.appendDiv(b,"snippet-"+c,"snippetDiv");0==d.responsiveContent?(d.contentDiv=a.appendDiv(d.div,"snippet-content-"+c,"snippet-content"),d.contentDiv.html(d.snippet),d.loadAttempt=0,d.loadTimer=setInterval(function(){a:{var a=d,c=b[0],e=a.contentDiv[0].clientWidth,h=a.contentDiv[0].clientHeight;
if(0==e||0==h)if(a.loadAttempt++,4<a.loadAttempt)e=a.size.x.value,h=a.size.y.value,a.contentDiv.css({left:0,top:0,width:e,height:h});else break a;clearInterval(a.loadTimer);a.loadTimer=void 0;a.divSize={width:e,height:h};q(a,p(a,c));a.div.animate({opacity:1},{duration:500})}},1E3)):(q(d,p(d,b)),d.div.html(d.snippet),d.div.animate({opacity:1},{duration:500}))}}var n=null,e=[],m=[];this.init=function(a){n={};$.extend(!0,n,a);this.loadSnippets()};this.loadSnippets=function(){$.get(ipcamliveHostManager.getHostURL("player/getoverlaypaneldata.php"),
{_:$.now(),alias:n.cameraAlias},function(a){if(void 0!=a&&void 0!=a.overlaypanelenabled&&0!=a.overlaypanelenabled&&void 0!=a.overlaypanelcode)try{r(JSON.parse(a.overlaypanelcode)),t()}catch(b){browserhelper.log("Failed to parse overlay data.")}},"json").fail(function(a,b,c){})};this.getPosition=p;this.resize=function(){for(var a=$("#"+n.videoContainerTag),b=0;b<e.length;b++)q(e[b],p(e[b],a[0]))};this.setSnippets=function(a){for(var b=0;b<e.length;b++){var c=e[b];c.div.remove();void 0!=c.loadTimer&&
clearInterval(c.loadTimer)}m=[];e=[];r(a);t()};this.hideSnippetsByElement=function(a,b,c){for(var d=0;d<e.length;d++)AABB.collide(e[d].div,a,!0,.15)&&(e[d].div.delay(b).animate({opacity:.25},{duration:c}),m.push(d))};this.showHidedSnippets=function(a,b){for(var c=0;c<m.length;c++)e[m[c]].div.delay(a).animate({opacity:1},{duration:b});m=[]}};
...
$jscomp.polyfill("String.prototype.startsWith",function(b){return b?b:function(a,d){var f=$jscomp.checkStringArgs(this,a,"startsWith");a+="";var b=f.length,q=a.length;d=Math.max(0,Math.min(d|0,f.length));for(var M=0;M<q&&d<b;)if(f[d++]!=a[M++])return!1;return M>=q}},"es6","es3");
...
function iplayer(){iplayerEx.call(this);this.setOnCreateVideoPlayer(function(b){var a=1==browserhelper.getParam(b,"disabletimelapseplayer",!1)||0==browserhelper.getParam(b,"timelapseenabledoncamera",!1);if("B"==b.servicetype||1==a||1==browserhelper.isSafariMobile()||0==browserhelper.isHTML5Supported())browserhelper.log("Live player created"),browserhelper.log("Service type: "+b.servicetype),browserhelper.log("Timelapse player enabled: "+b.timelapseplayerenabled),browserhelper.log("Timelapse enabled on camera: "+
b.timelapseenabledoncamera),browserhelper.log("Unsupported safari on iOS: "+browserhelper.isSafariMobile()),browserhelper.log("HTML5 supported: "+browserhelper.isHTML5Supported());else{a="";if(void 0!=b.rtcsupport&&1==b.rtcsupport){a="infinite\\";var d=ipcamliveHostManager.getHostURL("timelapses/"+b.alias+"/");1==d.startsWith("http://g")?d=d.replace("http://g","http://t"):1==d.startsWith("https://g")&&(d=d.replace("https://g","https://t"))}else d=b.address+"timelapses/"+b.alias+"/";browserhelper.log("Timelapse player created. Path: "+
d);var f=void 0,g=!0;b.hasOwnProperty("displaymode")&&"timelapse"==b.displaymode&&(f=b.hasOwnProperty("initialtimelapse")?b.initialtimelapse:"first",b.hasOwnProperty("hidelivebutton")&&1==b.hidelivebutton&&(g=!1));return new timeLapseOnLiveVideoPlayer(d,a,f,g)}})}
function timeLapseOnLiveVideoPlayer(b,a,d,f){function g(){var c=1==y?m:l;c=void 0!=c?c.getVideoPlayer()[0]:void 0;return void 0!=c?0==c.paused:!1}function q(c){v=e.htmlStyledDiv($("#"+Y),"base","width:100%; height:100%; position:relative; background:#000; "+browserhelper.getOverflowValue(c));v.on("resize",N)}function M(c){m=new ihtml5video(la);$.extend(z,c);m.setExtraParams(Z);z.uniqid=ma;z.onControlsCreated=na;void 0!=d&&(Q=z.hasOwnProperty("autoplay")&&1==z.autoplay,z.autoplay=!1);aa=e.appendStyledDiv(v,
"live_ipc_ic","width:100%; height:100%; position:absolute; z-index:1");aa.on("mousemove",oa);m.player(aa[0].id,z,!1)}function pa(c){for(var n=qa,a=ra,b=!1,g=a.length-1;0<=g;g--){var f=a[g].split("*"),k="d"==f[0];1==k?(f=f[1].trim(),p.push({displayName:f,sourceDir:n+f+"/",isDaily:k})):b=!0}1==b&&p.unshift({displayName:ipcLocale.longLapse,sourceDir:n+La,isDaily:!1});a:{if(void 0!=d&&""!=d){if(e.compareStr(d,"first"))n=0<p.length?0:-1;else{if(e.compareStr(d,"long-lapse")||e.compareStr(d,"longlapse")||
e.compareStr(d,"infinite"))d=ipcLocale.longLapse;b:{for(n=0;n<p.length;n++)if(p[n].displayName==d)break b;n=-1}0>n&&(0<p.length?(n=0,browserhelper.log("Initial timelapse not found. Load first one.")):browserhelper.log("Initial timelapse load fail, no timelapses"))}if(0<=n){a=sa(n);a.index=n;n=a;break a}}n=void 0}l=new ihtml5video(la);$.extend(h,c);l.setExtraParams(Z);h.uniqid=ma;h.onControlsCreated=na;void 0!=n?(h.poster=n.poster,h.source=n.source):(h.poster="",h.source="");E=e.appendDiv(v,"timelapse_ipc_ic",
"playerContainer");E.css("z-index","0");E.on("mousemove",oa);l.player(E[0].id,h,!0);Ma();c=e.openList("live_timelapse_items","liveTimelapseList");c=e.addListItem("live",c,"itemTextLive",ipcLocale.live);c=e.addListSeparator("liveSep",c,"listSeparator");B.append(e.closeList(c));a=e.openList("timelapse_items","timelapseList");for(b=0;b<p.length;b++)c=p[b],a=e.addListItem("item"+b,a,"itemText",c.displayName);B.append(e.closeList(a));for(b=0;b<p.length;b++)c=p[b],c.div=e.getElem("item"+b),c.pad=15*-b,
c.div.css("margin-left",c.pad),c.div.on("click",Na),c.div[0].setAttribute("data-index",b),ipcStyleManager.setFontStyle(c.div,h.style),ta(c.div,h.style.text.color,h.style.colors.panelsBackground);A=e.getElem("live");A.on("click",Oa);A.hide();ipcStyleManager.setMainColorAndFont(A,h.style);ta(A,h.style.colors.main,h.style.colors.panelsBackground);G=e.getElem("liveSep");G.hide();c=e.getElem("timelapse_items");(new GeminiScrollbar({element:c[0]})).create();N();void 0!=m&&m.setOnControlBarUpdateEvent(ua);
l.setOnControlBarUpdateEvent(ua);l.setOnFitChangeEvent(N);document.addEventListener("fullscreenchange",R);document.addEventListener("webkitfullscreenchange",R);document.addEventListener("mozfullscreenchange",R);document.addEventListener("MSFullscreenChange",R);1==t&&window.addEventListener("orientationchange",Pa);void 0!=n?(l.getControls().setSourceName(n.displayName),va(n.index,!1,!1),ba()):void 0!=d&&1==Q&&m.start()}function Ma(){F=h.style.timelapse.panelWidth;ipcLocaleHead&&F<ipcLocaleHead.minTimelapsePanelWidth&&
(F=ipcLocaleHead.minTimelapsePanelWidth);C=e.appendDiv(v,"base_left_panel","baseLeftPanel");C.css("left",-F+"px");C.css("width",F+"px");B=e.appendDiv(C,"timelapse_panel","timeLapsePanel");ipcStyleManager.setPanelStyle(B,h.style);if(1==t)B.on("touchmove",Qa);k=e.appendDiv(v,"timelapse_panel_toggler","timeLapsePanelToggler");k.click(D);k.css("left","-32px");k.show();k.delay(500).animate({left:"0px"},500,"swing");ipcStyleManager.setBackgroundImage(k,h.style.timelapse.openPanel,h.style);0==t&&k.hover(function(){$(this).addClass(e.getClass("timeLapsePanelTogglerHover"))},
function(){$(this).removeClass(e.getClass("timeLapsePanelTogglerHover"))});r=e.appendDiv(E,"timePanel","timePanel");ipcStyleManager.setPanelStyle(r,h.style);S=e.appendDiv(r,"timePanelDate","timePanelDate");H=e.appendDiv(r,"timePanelTime","timePanelTime");r.hide();ipcStyleManager.setFontStyle(S,h.style);ipcStyleManager.setFontStyle(H,h.style);0==t&&v.hover(function(){r.animate({opacity:"1.0"},250)},function(){r.animate({opacity:"0.30"},250);g()&&wa();1==x&&0==I&&xa(!1)})}function Ra(c){w=void 0;$.get(c,
...
1==b&&c.addClass(e.getClass("itemTextHoverAnimation"))}function da(c,a,b){1==b&&c.removeClass(e.getClass("itemTextHoverAnimation"));1==a&&(c.removeClass(e.getClass("itemTextHover")),ipcStyleManager.removeBackgroundImage(c),ipcStyleManager.setBackgroundColor(c,c.data("originalBackground")),ipcStyleManager.setColor(c,c.data("originalColor")))}function ta(c,a,b){c.data("originalColor",a);c.data("originalBackground",b);0==t&&c.hover(function(){void 0!=u&&u[0]==$(this)[0]||ca($(this),!0,!0)},function(){void 0!=
u&&u[0]==$(this)[0]||da($(this),!0,!0)})}function ya(c,a){void 0!=u&&da(u,!0,!1);u=c;1==t?ca(u,!0,!0):1==a&&ca(u,!0,!1)}function xa(c){I=!0;if(c){var a=F;C.animate({left:"0px"},500,"swing",ba);B.animate({opacity:h.style.colors.panelsBackgroundOpacity},500);for(var b=0;b<p.length;b++){var d=p[b];d.div.animate({marginLeft:"0px"},300+500*Math.random())}}else for(a=0,C.animate({left:-F+"px"},600,"swing",Sa),B.animate({opacity:"0.0"},600),b=0;b<p.length;b++)d=p[b],d.div.animate({marginLeft:d.pad+"px"},
300+500*Math.random());B.css("z-index","2");ea();1==t&&(1==c?k.addClass(e.getClass("timeLapsePanelTogglerHover")):k.removeClass(e.getClass("timeLapsePanelTogglerHover")));k.animate({opacity:c?"0.0":"0.75",left:a+"px"},{duration:c?400:750},"linear");x=c}function D(){0==x&&void 0!=u&&da(u,!1,!0);xa(!x);V();1==x?za():(g()&&fa(),Aa())}function ea(){C&&C.css("height",v[0].clientHeight-Ba+"px")}function Ca(){1==W&&(W=!0,Da(Ca));if(void 0!=O){var c=l.getVideoPlayer();if(c&&c[0]){var a=c[0].duration;c=c[0].currentTime;
0<=c&&0<a&&0<U&&(a-=U,c>=a&&(a=Math.floor((c-a)*T),0<=a&&a<w.length&&(a=d3.timeParse("%Y-%m-%d %H:%M:%S")(w[a].trim()),O.isDaily?(S.text(d3.timeFormat("%Y")(a)+"."+d3.timeFormat("%m")(a)+"."+d3.timeFormat("%d")(a)),H.text(d3.timeFormat("%H:%M")(a))):(S.text(d3.timeFormat("%Y")(a)+"."+d3.timeFormat("%m")(a)+"."+d3.timeFormat("%d")(a)),H.text(d3.timeFormat("%A")(a))),Ea(),r.is(":visible")||r.show())))}}}function Ea(){if(void 0!=O){var a=0,b=0;if(l&&l.getVideoPlayer()&&0==l.getControls().get_isVideoFit()){var d=
l.getVideoPlayer()[0].videoWidth,e=l.getVideoPlayer()[0].videoHeight,f=d/e,g=E.width(),h=E.height();g/d<=h/e?b=(h-g/f)/2:a=(g-h*f)/2}r.css("margin-right",25+a+"px");r.css("margin-top",25+b+"px")}}function wa(){k&&1!=J&&(J=1,k.fadeTo(250,0,function(){J=0}))}function ha(a){1!=ia&&(k&&2!=J&&(J=2,k.fadeTo(250,.75,function(){J=0})),void 0!=a&&0==a?V():g()&&fa())}function Fa(a){ja&&ja.cancel();var c=e.getElem("live_ipc_ic"),b=e.getElem("timelapse_ipc_ic");y?(c.removeClass(K),b.removeClass(L),1==a?(c.addClass("pt-page-moveToRightEasingSlow"),
b.addClass("pt-page-moveFromLeftEasingFast"),K="pt-page-moveToRightEasingSlow",L="pt-page-moveFromLeftEasingFast"):(L=K="",c.hide()),c.css("z-index","1"),b.css("z-index","0"),b.show(),W=!0,Da(Ca)):(W=!1,c.removeClass(K),b.removeClass(L),1==a?(K="pt-page-moveFromLeftEasingFast",L="pt-page-moveToRightEasingSlow",c.addClass("pt-page-moveFromLeftEasingFast"),b.addClass("pt-page-moveToRightEasingSlow")):(L=K="",b.hide()),c.css("z-index","0"),b.css("z-index","1"),c.show());y=!y;1==x&&D();V();ja=ipcamlivehelper.createTimeout(function(){if(y)l.stop();
else{var a=z.hasOwnProperty("autoplay")&&1==z.autoplay;ka=void 0!=m&&m.stop()&&1==a||Q;Q=!1}},500)}function Pa(){window.orientation!=Ga&&(Ga=window.orientation,Ha())}function N(){if(k){0<=k.position().left&&k.css("left","0px");var a=v[0].clientHeight/2-32+"px",b=k.position().top;b==v[0].clientHeight?k.css("top",a):250>Math.abs(b-a)?k.animate({top:a},250):k.css("top",a)}Ea();ea()}function Ha(){ia=!0;1==x&&D();r.hide();k.hide();setTimeout(function(){ia=!1;N();0!=g()&&1!=t||ha();0==y&&void 0!=r&&r.show()},
500)}function oa(){0==t&&(x&&0==I&&D(),0==I&&ha())}function R(){Ha()}function ua(a,b){b=1==y?m:l;void 0!=b&&(a=b.getControls().get_controlBarHeight()+a,0==isNaN(a)&&(Ba=a));ea()}function na(a){a.overrideFullscreenElement(v);a.setDiscardClickEvent(Ta);var b=a.get_video();b.on("play",Ia);if(l&&a==l.getControls())b.on("loadedmetadata",Ia)}function Ia(){1==x&&D();g()&&fa()}function Ta(a){if(1==t&&x&&!I)return D(),!0;ha(1==t);return!1}function Qa(){1==t&&void 0!=P&&za()}function Oa(){ya($(this),!1);Fa(!0);
ka&&(m.start(),ka=!1)}function sa(a){var b={};b.source=p[a].sourceDir+"video.mp4";b.poster=p[a].sourceDir+"snapshot.jpg";b.displayName=p[a].displayName;return b}function va(a,b,d){var c=p[a];void 0!=c&&(c=c.div,u&&u[0]==c[0]||(ya(c,0==b),y?Fa(b):D(),U=T=-1,O=p[a],r.hide(),O.isDaily?H.css("font-size","2em"):H.css("font-size","1.25em"),1==d&&(b=sa(a),l.setSource(b.source,b.poster,b.displayName)),Ra(p[a].sourceDir+"video.dat")))}function Na(a){va(a.target.getAttribute("data-index"),!0,!0)}function ba(){y?
(A&&A.hide(),G&&G.hide()):0==(void 0!=d&&""!=d&&0==f)&&(A&&A.show(),G&&G.show());I=!1}function Sa(){ba()}function Aa(){0!=t&&P&&(clearTimeout(P),P=void 0)}function za(){0!=t&&(Aa(),P=setTimeout(D,5E3))}function V(){X&&(clearTimeout(X),X=void 0)}function fa(){V();X=setTimeout(wa,3E3)}var ma=ipcamlivehelper.generateString(8),t=browserhelper.isMobileBrowser(),y=!0,ka=!1,Ga=void 0,ia=!1,Q=!1,e=new htmlEditHelperClass,la={},ja=void 0,P=void 0,X=void 0,Ja=!1,Ka=!1,v=void 0,Y=void 0,aa=void 0,E=void 0,m=
void 0,z={},l=void 0,h={},Z=void 0,C=void 0,B=void 0,F=125,Ba=0,x=!1,k=void 0,I=!1,A=void 0,G=void 0,u=void 0,J=0,r=void 0,S=void 0,H=void 0,T=-1,U=-1,w=void 0,O=void 0,p=[],La=a,ra=void 0,qa=b,K="",L="",W=!1,Da=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(a){window.setTimeout(a,100)}}();this.player=function(a,b){Y=a;e.setContainerName(Y);q(b);void 0!=d&&void 0!=f&&1!=f||M(b);$.get(qa+"timelapselist.dat",{},function(a){0<
a.length&&(Ka=!0,(ra=e.splitList(a))&&1==Ja&&pa(b))}).fail(function(){});a=dependencyhelper.createVersionedCSSFileName("player/html5player/mainplayer",IPC_MAIN_CCS_VERSION);dependencyhelper.load_css(ipcamliveHostManager.getHostURL(a),function(){Ja=!0;1==Ka&&pa(b)});return!0};this.setEvents=function(a,b){void 0!=m&&m.setEvents(a,b);void 0!=l&&l.setEvents(a,b)};this.destroyObjects=function(){void 0!=m&&m.destroyObjects()};this.resize=function(){void 0!=m&&m.resize();void 0!=l&&l.resize()};this.setExtraParams=
function(a){Z=a};this.getWebSocketDelay=function(){return void 0!=m?m.getWebSocketDelay():0};this.setSnippets=function(a){if(void 0!=m)return m.setSnippets(a)};this.setCheckStreamState=function(a){};$(window).resize(function(){N()})}var ipcamliveplayer=new iplayer;
/*
 *****************************************************************************
